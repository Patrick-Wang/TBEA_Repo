...
var stringDescription =  '<div class="container">'
        + '<div class="navbar-header">'
          + '<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">'
            ...
            + '<span class="icon-bar"></span>'
          + '</button>'
          + '<a class="navbar-brand" href="http://www.tbea.com.cn">特变电工主数据管理平台</a>'
        + '</div>'
        + '<div class="navbar-collapse collapse" id="nav-wrap">'
          + '<ul class="nav navbar-nav navbar-right" id="nav" style="max-width:100%;">'
            + '<li class="' + (activeClass.Sample || '') + '" onclick="delegateCall(this);" value="1"><a style="cursor:pointer">主数据查询</a></li>'
+ '<li class="' + (activeClass.Sample || '') + '" onclick="delegateCall(this);" value="2"><a style="cursor:pointer">主数据接口说明</a></li>';
			if (!RELEASE){
     ...
     '<div class="container">'
        + '<div class="row" style="padding-bottom:20px;">'
            ...
            + '<div class="col-md-3">'
                + '<p>联系我们</p>'
                + '<ul>'
                    + '<li><a href="mailto:wangxin11@tbea.com">wangxin11@tbea.com</a></li>'
                    // + '<li><a href="http://www.tbea.com.cn/default.aspx"
