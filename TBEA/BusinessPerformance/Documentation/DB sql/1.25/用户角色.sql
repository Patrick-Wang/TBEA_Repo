...
select ur.userId account_id, seat.companyId company_id, seat.authId auth_type from user_roles ur left join system_extend_auth_t seat on ur.roleId = seat.roleId 