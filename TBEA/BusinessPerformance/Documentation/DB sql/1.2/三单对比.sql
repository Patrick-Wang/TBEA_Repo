...
CREATE TABLE [dbo].[JYGK_SDDB_ORDER_EXECUTION_DETAILS](
	...
	completion_year	[numeric](18, 4)	,--Yes	完工年份
	completion_month	[numeric](18, 4)	,--Yes	完工月份
	...
	tax_inclusive_price	[numeric](18, 4)	,--Yes	合同金额
	not_tax_inclusive_price	[numeric](18, 4)	,--Yes	合同金额（不含税）
	nc_number	[numeric](18, 4)	,--Yes	NC数量
	nc_cost	[numeric](18, 4)	,--Yes	NC成本
	...
	es_remarks	nvarchar(1000)	,--Yes	测算_备注
	...
	op_strip_reduction	[numeric](18, 4)	,--Yes	优化阶段_条料还原
	...
	op_copper_allocation	[numeric](18, 4)	,--Yes	优化阶段_铜分摊套保
	...
	op_price_remarks	[numeric](18, 4)	,--Yes	优化阶段_价格备注
