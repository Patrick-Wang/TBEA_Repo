...
id name
*****************************************************************************/
IF EXISTS ( SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'identifier_zdcpdl')
DROP TABLE identifier_zdcpdl
CREATE TABLE [dbo].[identifier_zdcpdl](
	[id] [int] IDENTITY(1,1) NOT NULL,
	[name] [varchar](50) not NULL,
	[lb] int --0 变压器   1 线缆
PRIMARY KEY CLUSTERED 
...
SET IDENTITY_INSERT [dbo].[identifier_zdcpdl] ON
INSERT [dbo].[identifier_zdcpdl] ([id], [name], [lb]) VALUES (1,N'卷铁芯', 0)
INSERT [dbo].[identifier_zdcpdl] ([id], [name], [lb]) VALUES (2,N'非晶合金', 0)
INSERT [dbo].[identifier_zdcpdl] ([id], [name], [lb]) VALUES (3,N'高压开关', 0)
INSERT [dbo].[identifier_zdcpdl] ([id], [name], [lb]) VALUES (4,N'互感器', 0)
INSERT [dbo].[identifier_zdcpdl] ([id], [name], [lb]) VALUES (5,N'二次类产品', 0)
INSERT [dbo].[identifier_zdcpdl] ([id], [name], [lb]) VALUES (6,N'导线', 1)
INSERT [dbo].[identifier_zdcpdl] ([id], [name], [lb]) VALUES (7,N'布电线', 1)
INSERT [dbo].[identifier_zdcpdl] ([id], [name], [lb]) VALUES (8,N'特缆', 1)
SET IDENTITY_INSERT [dbo].[identifier_zdcpdl] OFF
