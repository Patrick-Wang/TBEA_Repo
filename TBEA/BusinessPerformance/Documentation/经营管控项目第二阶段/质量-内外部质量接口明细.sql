...
CREATE TABLE [dbo].[zl_wbyclzlwt](
	...
	[production_num] [varchar](240) ,
	[production_model] [varchar](240) ,
	[issue_type] [varchar](240) ,
	[sub_issue_type] [varchar](240) ,
	[category_code] [varchar](240) ,
	[quality_phenomenon] [varchar](240) ,
	[detail] [varchar](1000)  ,
	[material_count] [numeric](18, 4),
	[measurement_units] [varchar](240) ,
	[suppier_id] [varchar](240),
	[suppier] [varchar](240),
	[responsibility_department] [varchar](240) ,
	[filling_personnel] [varchar](240) ,
	[product_delivery_date] date,
	[failure_subject] [varchar](240) ,
	[material_treatment_measure] [varchar](500) ,
	[onsite_treatment_measure] [varchar](1000) ,
	[onsite_treatment_result] [varchar](1000) ,
	[user_unit] [varchar](240) ,
	[onsite_after_sales] [varchar](240) ,
	[after_sales_tel] [varchar](240),
	[source] [varchar](50),
	[time] [datetime],
	[zt] [int]
...
CREATE TABLE [dbo].[zl_nbyclzlwt](
	...
	[sub_issue_type] [varchar](240) ,
	[category_code] [varchar](240) ,
	[material_quality_phenomenon] [varchar](240) ,
	[detail] [varchar](1000)  ,
	[material_happen_phase] [varchar](240) ,
	[material_count] [numeric](18, 4),
	[measurement_units] [varchar](240) ,
	[suppier_id] [varchar](240),
	[suppier] [varchar](240),
	[issue_process] [varchar](240) ,
	[responsibility_department] [varchar](240) ,
	[material_treatment_measure] [varchar](500) ,
	[onsite_treatment_measure] [varchar](1000) ,
	[onsite_treatment_result] [varchar](1000) ,
