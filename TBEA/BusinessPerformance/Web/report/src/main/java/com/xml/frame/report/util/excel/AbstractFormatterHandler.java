...
public abstract class AbstractFormatterHandler implements FormatterHandler {
	...
	protected String callNext(String zbName, Integer col, ExcelHelper template, HSSFCell cell, String val){
	...
	abstract protected String onHandle(ExcelHelper template, HSSFCell cell, String val);
	
	@Override
	public String handle(String zbName, Integer col, ExcelHelper template,
