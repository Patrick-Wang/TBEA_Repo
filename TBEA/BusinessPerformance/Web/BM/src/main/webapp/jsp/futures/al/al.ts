...
module futures {
    export module al {
        ...
        class AlView extends BasePluginView {
            private mData:receivedData;
            private mChartData:Array<chartObject>;
            private mTableData:string[][];
            private mAjax:Util.Ajax = new Util.Ajax("update.do?type=2", false);

            public static newInstance():AlView {
                return new AlView();
            }
        ...
        export var pluginView = AlView.newInstance();
    }
}
