...
<script src="${pageContext.request.contextPath}/jsp/nyzbscqk/nyzbscqk.js" type="text/javascript"></script>
<title>能源周边市场情况</title>
...
<body>
	...
	<Table id="frameTable" align="center" style="width:1200px">
		...
		<tr>
			<td id="plugin">
				<%@include file="nyzbscjg/nyzbscjg.jsp"%>
				<%@include file="nyzbscxl/nyzbscxl.jsp"%>
			</td>
		</tr>
		<tr>
			<td>
