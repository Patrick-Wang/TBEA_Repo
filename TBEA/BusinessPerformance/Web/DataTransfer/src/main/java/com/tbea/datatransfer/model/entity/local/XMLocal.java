...
@Entity
@Table(name = "cb_zj_xm")
public class XMLocal extends AbstractReadWriteEntity implements Serializable {
	...
	public String toString() {
		return "XMLocal [id=" + getId() + ", gxrq=" + gxrq + ", xmbh=" + xmbh
				+ ", xmmc=" + xmmc + ", ddszdw=" + ddszdw + ", yhdwmc="
				+ yhdwmc + ", khhylx=" + khhylx + ", gb=" + gb + ", qybh="
				+ qybh + "]";
	}
