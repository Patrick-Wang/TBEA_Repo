...
public class FKFSXLGWLocal extends AbstractReadWriteEntity {
	...
	public String toString() {
		return "FKFSXLGWLocal [id=" + getId() + ", gxrq=" + gxrq + ", ny=" + ny
				+ ", gsbm=" + gsbm + ", sfjzzb=" + sfjzzb + ", gwhtddzlbs="
				+ gwhtddzlbs + ", gwhtddzlje=" + gwhtddzlje + ", n3_06_0_01bs="
				...
				+ zbqcgynhtje + ", sfdrwc=" + sfdrwc + ", qybh=" + qybh + "]";
	}
