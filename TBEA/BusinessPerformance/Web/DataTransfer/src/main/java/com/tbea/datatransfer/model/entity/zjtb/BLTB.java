...
public class BLTB extends AbstractReadOnlyEntity implements Serializable {
	...
	public String toString() {
		return "BLDL [id=" + getId() + ", gxrq=" + gxrq + ", blbh=" + blbh
				+ ", htbh=" + htbh + ", blrq=" + blrq + ", kxxz=" + kxxz
				+ ", blje=" + blje + ", bldqr=" + bldqr + ", kxdqr=" + kxdqr
				+ ", blhkje=" + blhkje + ", blye=" + blye + ", sfdrwc="
				+ sfdrwc + "]";
	}
