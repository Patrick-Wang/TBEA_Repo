	...
	public @ResponseBody byte[] getByqnwbzlztqk(HttpServletRequest request,
		...
		if (all){
			...
			if (yjType == YDJDType.JD){
				result = byqnwbzlztqkService.getJdWbzlwtfl(d);
			}else{
				result = byqnwbzlztqkService.getYdWbzlwtfl(d);
			}
		}else{
			...
			if (yjType == YDJDType.JD){
				result = byqnwbzlztqkService.getJdWbzlwtfl(d, company);
			}else{
				result = byqnwbzlztqkService.getYdWbzlwtfl(d, company);
			}
		}
