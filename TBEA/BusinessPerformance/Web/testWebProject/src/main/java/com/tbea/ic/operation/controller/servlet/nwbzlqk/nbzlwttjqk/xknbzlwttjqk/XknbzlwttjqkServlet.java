package com.tbea.ic.operation.controller.servlet.nwbzlqk.nbzlwttjqk.xknbzlwttjqk;
...
@Controller
@RequestMapping(value = "xknbzlwttjqk")
public class XknbzlwttjqkServlet {
	...
	public @ResponseBody byte[] getXknbzlwttjqk(HttpServletRequest request,
		...
		List<List<String>> result = xknwbzlztqkService.getNbzlwttjqk(d, company, zts);
