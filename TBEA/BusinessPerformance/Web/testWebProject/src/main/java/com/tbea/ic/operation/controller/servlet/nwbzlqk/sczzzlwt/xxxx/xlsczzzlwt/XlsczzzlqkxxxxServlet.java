	...
	public @ResponseBody byte[] getByqnwbzlztqk(HttpServletRequest request,
		...
		if (all){
			...
			if (yjType == YDJDType.JD){
				result = xlnwbzlztqkService.getJdSczzzlqkxxxx(d);
			}else{
				result = xlnwbzlztqkService.getYdSczzzlqkxxxx(d); 
			}
		}else{
			...
			if (yjType == YDJDType.JD){
				result = xlnwbzlztqkService.getJdSczzzlqkxxxx(d, company);
			}else{
				result = xlnwbzlztqkService.getYdSczzzlqkxxxx(d, company);
			}
		}
