	...
	public @ResponseBody byte[] getByqnwbzlztqk(HttpServletRequest request,
		...
		if (comp == CompanyType.BYQCY){
			...
			if (yjType == YDJDType.JD){
				result = byqnwbzlztqkService.getJdYclzlwt(d, zts);
			}else{
				result = byqnwbzlztqkService.getYdYclzlwt(d, zts);
			}
			wis = byqnwbzlztqkService.getWaveItemsYclzlwt(d, yjType, zts);
		}else{

			if (yjType == YDJDType.JD){
				result = byqnwbzlztqkService.getJdYclzlwt(d, company, zts);
			}else{
				result = byqnwbzlztqkService.getYdYclzlwt(d, company, zts);
			}
			wis = byqnwbzlztqkService.getWaveItemsYclzlwt(d, yjType, company, zts);
		}
