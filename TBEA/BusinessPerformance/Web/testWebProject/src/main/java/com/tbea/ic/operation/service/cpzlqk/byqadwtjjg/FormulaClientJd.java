...
class FormulaClientJd implements FormulaClient<Pair<ZltjjgEntity, ZltjjgEntity>>{
	...
	public FormulaClientJd(ByqadwtjjgServiceImpl byqadwtjjgServiceImpl, ByqAdwtjjgEntity entity, ZltjjgEntity zltj1, ZltjjgEntity zltj2){
	...
	public Pair<Integer, Pair<ZltjjgEntity, ZltjjgEntity>> onThis() {
		...
		Util.resize(row, 8);
		this.byqadwtjjgServiceImpl.setRow(row, entity, pair.getSecond().getFirst(), pair.getSecond().getSecond());
		return pair;
	}
	...
	public Pair<Integer, Pair<ZltjjgEntity, ZltjjgEntity>> onFormula(
		...
		this.byqadwtjjgServiceImpl.setRow(row, entity, dj, tq);
