package com.tbea.ic.operation.model.dao.xl.yclbfqk;
...
public class XlYclbfqkDaoImpl implements XlYclbfqkDao {
	...
	@Override
	public List<Object[]> getYclbfqk(Date d) {
		...
		Query q = entityManager
				.createNativeQuery(
						...
						+ "apply_for_usage, "
						+ "waste_material "
						+ "from discarding_of_material where year = :year and month = :month");
