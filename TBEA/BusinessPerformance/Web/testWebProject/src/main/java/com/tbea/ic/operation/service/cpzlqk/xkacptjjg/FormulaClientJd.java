...
class FormulaClientJd implements FormulaClient<Pair<ZltjjgEntity, ZltjjgEntity>>{
	...
	private Map<Formula, XkJdAcptjjgEntity> forMap = new HashMap<Formula, XkJdAcptjjgEntity>();
	...
	public FormulaClientJd(XkacptjjgServiceImpl xkacptjjgServiceImpl,
...
//		ZltjjgEntity tj2 = tjjgDao.getJdAccQntq(d, forMap.get(formula).getCpxl().getId(), company, ZBStatus.APPROVED);
	...
	public void add(Formula formula, XkJdAcptjjgEntity entity) {
