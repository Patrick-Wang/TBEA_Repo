...
public class CompanyJjzjzCode {
	...
	public static List<String> toCodeList(List<Company> comps){
		...
		for (Company comp : comps){
			String code = CompanyJjzjzCode.getCode(comp.getType());
			if (null != code){
				ret.add("\'" + code + "\'");
			}
		}
