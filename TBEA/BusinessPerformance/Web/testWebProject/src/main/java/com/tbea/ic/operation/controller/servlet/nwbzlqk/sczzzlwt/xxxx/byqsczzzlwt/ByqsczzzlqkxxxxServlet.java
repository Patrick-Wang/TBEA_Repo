	...
	public @ResponseBody byte[] getByqsczzzlqk(HttpServletRequest request,
		...
		if (all){
			...
			if (yjType == YDJDType.JD){
				result = byqnwbzlztqkService.getJdSczzzlqkxxxx(d);
			}else{
				result = byqnwbzlztqkService.getYdSczzzlqkxxxx(d);
			}
		}else{
			...
			if (yjType == YDJDType.JD){
				result = byqnwbzlztqkService.getJdSczzzlqkxxxx(d, company);
			}else{
				result = byqnwbzlztqkService.getYdSczzzlqkxxxx(d, company);
			}
		}
