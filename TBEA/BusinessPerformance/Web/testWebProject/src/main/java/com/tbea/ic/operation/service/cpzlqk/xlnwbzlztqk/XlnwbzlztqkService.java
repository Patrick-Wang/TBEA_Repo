...
public interface XlnwbzlztqkService {
	...
	List<List<String>> getJdGyzlwt(Date d, List<Integer> zts);

	List<List<String>> getYdGyzlwt(Date d, List<Integer> zts);

	List<List<String>> getJdGyzlwt(Date d, Company company, List<Integer> zts);

	List<List<String>> getYdGyzlwt(Date d, Company company, List<Integer> zts);

	List<WaveItem> getWaveItemsGyzlwt(Date d, YDJDType yjType, Company company, List<Integer> zts);

	List<List<String>> getJdYclzlwt(Date d, List<Integer> zts);

	List<List<String>> getYdYclzlwt(Date d, List<Integer> zts);
	
	List<WaveItem> getWaveItemsGyzlwt(Date d, YDJDType yjType, List<Integer> zts);
	...
	List<WaveItem> getYclzlwtWaveItems(Date d, YDJDType yjType, Company company, List<Integer> zts);
	
	List<WaveItem> getYclzlwtWaveItems(Date d, YDJDType yjType, List<Integer> zts);
