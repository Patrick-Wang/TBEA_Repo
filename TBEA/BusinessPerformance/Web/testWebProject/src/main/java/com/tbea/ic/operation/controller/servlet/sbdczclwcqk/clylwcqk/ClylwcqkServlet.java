...
public class ClylwcqkServlet {
	...
	public @ResponseBody byte[] getClylwcqk(HttpServletRequest request,
		...
		List<List<String>> result = clylwcqkService.getClylwcqk(d, company);
	...
	public @ResponseBody byte[] updateClylwcqk(HttpServletRequest request,
		...
		List<List<String>> result = clylwcqkService.getClylwcqkEntry(d, company);
		return JSONArray.fromObject(result).toString().replaceAll("null", "\"\"").getBytes("utf-8");
	}
	...
	public @ResponseBody byte[] saveClylwcqk(HttpServletRequest request,
		...
		ErrorCode err = clylwcqkService.saveClylwcqk(d, data, company);
	...
	public @ResponseBody byte[] submitClylwcqk(HttpServletRequest request,
		...
		ErrorCode err = clylwcqkService.submitClylwcqk(d, data, company);
		return Util.response(err);
	}
	...
	public void exportClylwcqk(HttpServletRequest request,
		...
		List<List<String>> ret = clylwcqkService.getClylwcqk(d, company);
		ExcelTemplate template = ExcelTemplate.createSbdczclwcqkTemplate(SbdczclwcqkSheetType.CLYLWCQK);
