...
class FormulaClientYd implements FormulaClient<Pair<ZltjjgEntity, ZltjjgEntity>>{
	...
	private final XkacptjjgServiceImpl xkacptjjgServiceImpl;
	protected List<Formula> formulaOrder = new ArrayList<Formula>();
	private Map<Formula, XkYdAcptjjgEntity> forMap = new HashMap<Formula, XkYdAcptjjgEntity>();
	...
	public FormulaClientYd(XkacptjjgServiceImpl xkacptjjgServiceImpl,
			ZltjjgDao tjjgDao, Company company, Date d, List<Integer> zts) {
		super();
		this.zts = zts;
		this.xkacptjjgServiceImpl = xkacptjjgServiceImpl;
	...
	public Pair<Integer, Pair<ZltjjgEntity, ZltjjgEntity>> onThis(
		...
		this.xkacptjjgServiceImpl.setRow(r, forMap.get(formula), pair.getSecond().getFirst(), pair.getSecond().getSecond());
	...
	public Pair<Integer, Pair<ZltjjgEntity, ZltjjgEntity>> onFormula(
		...
		this.xkacptjjgServiceImpl.setRow(r, forMap.get(formula), dj, tq);
	...
	public void add(Formula formula, XkYdAcptjjgEntity entity) {
