package com.tbea.ic.operation.controller.servlet.nwbzlqk.yclzlwt.xlyclzlwt;
...
@Controller
@RequestMapping(value = "xlyclzlwt")
public class XlYclzlwtServlet {
	...
	public @ResponseBody byte[] getByqnwbzlztqk(HttpServletRequest request,
		...
		if (all){
			...
			if (yjType == YDJDType.JD){
				result = xlnwbzlztqkService.getJdYclzlwt(d);
			}else{
				result = xlnwbzlztqkService.getYdYclzlwt(d);
			}
			wis = xlnwbzlztqkService.getYclzlwtWaveItems(d, yjType);
		}else{
			CompanyType comp = CompanySelection.getCompany(request);
			Company company = companyManager.getVirtualCYOrg().getCompany(comp);
			
			if (yjType == YDJDType.JD){
				result = xlnwbzlztqkService.getJdYclzlwt(d, company);
			}else{
				result = xlnwbzlztqkService.getYdYclzlwt(d, company);
			}
			wis = xlnwbzlztqkService.getYclzlwtWaveItems(d, yjType, company);
		}
