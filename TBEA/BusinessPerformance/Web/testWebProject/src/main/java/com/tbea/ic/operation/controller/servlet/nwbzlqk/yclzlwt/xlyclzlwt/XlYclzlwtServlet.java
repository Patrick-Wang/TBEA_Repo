	...
	public @ResponseBody byte[] getByqnwbzlztqk(HttpServletRequest request,
		...
		if (comp == CompanyType.XLCY){
			...
			if (yjType == YDJDType.JD){
				result = xlnwbzlztqkService.getJdYclzlwt(d, zts);
			}else{
				result = xlnwbzlztqkService.getYdYclzlwt(d, zts);
			}
			wis = xlnwbzlztqkService.getYclzlwtWaveItems(d, yjType, zts);
		}else{

			if (yjType == YDJDType.JD){
				result = xlnwbzlztqkService.getJdYclzlwt(d, company, zts);
			}else{
				result = xlnwbzlztqkService.getYdYclzlwt(d, company, zts);
			}
			wis = xlnwbzlztqkService.getYclzlwtWaveItems(d, yjType, company, zts);
		}
