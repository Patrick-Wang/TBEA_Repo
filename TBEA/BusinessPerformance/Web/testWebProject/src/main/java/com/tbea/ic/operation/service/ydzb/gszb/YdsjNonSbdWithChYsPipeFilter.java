...
public class YdsjNonSbdWithChYsPipeFilter implements IPipeFilter {
	...
	public YdsjNonSbdWithChYsPipeFilter(YDJHZBDao ydjhDao, int col,
	...
	private void updateCacheValues(GszbPipe pipe) {
		if (null == cacheValues) {
			...
			cacheValues = ydjhzbDao.getDyjhz(this.startDate, this.endDate, zbsTmp,
