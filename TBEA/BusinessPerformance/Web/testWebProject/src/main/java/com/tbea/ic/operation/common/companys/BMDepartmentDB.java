...
public class BMDepartmentDB extends AbstractOrganization {
    ...
    static {
        ...
        id_typeMap.put(302, CompanyType.XBZTGS);
        ...
        id_typeMap.put(1301, CompanyType.GCLZPGS);
        ...
        //融资业务
        id_typeMap.put(2000, CompanyType.JGCGZX);
...
//        208 特变电工湖南电气有限公司
//        209特变电工衡阳变压器公司众业分公司
        id_typeMap.put(605, CompanyType.TBDGDLDLSYB);//特变电工（德缆）电缆事业部"),
        id_typeMap.put(606, CompanyType.TBDGDLGJGCGS);//特变电工（德缆）国际工程公司"),
        id_typeMap.put(707, CompanyType.BYDC);//北一电厂"),
        id_typeMap.put(1009, CompanyType.XJXTXNJCGS);//新疆新特新能建材有限公司"),
        id_typeMap.put(1010, CompanyType.XJXTNYWLGS);//新疆新特能源物流有限公司"),
        id_typeMap.put(1317, CompanyType.XJZHJYMYGS);//新疆众和金源镁业公司"),
        id_typeMap.put(208, CompanyType.TBDGHNDQYXGS);//特变电工湖南电气有限公司"),
        id_typeMap.put(209, CompanyType.TBDGHYBYQGSZHFGS);//特变电工衡阳变压器公司众业分公司");
    }
    ...
    void setEntityManager(EntityManager entityManager) {
        Query q = entityManager.createQuery("from DWXX where parent_ID is null");
