...
public class BMDepartmentDB extends AbstractOrganization {
	...
	static {
		...
		id_typeMap.put(111, CompanyType.SBYXGS);
		...
		id_typeMap.put(303, CompanyType.XBYTGS);
		id_typeMap.put(304, CompanyType.XBXBGS);
		id_typeMap.put(305, CompanyType.XBGJCTGCGS);
		id_typeMap.put(306, CompanyType.XBGNGCJXGS);
		id_typeMap.put(307, CompanyType.XJXTGJWLMYGS);
		...
		id_typeMap.put(1008, CompanyType.XJYXGS);
