...
public class BMDepartmentDB extends AbstractOrganization {
	...
	static {
		...
		id_typeMap.put(10, CompanyType.XNY);
		id_typeMap.put(9, CompanyType.GY);
		...
		id_typeMap.put(11111, CompanyType.SBDCY);
		id_typeMap.put(33333, CompanyType.XNYCY);
		id_typeMap.put(22222, CompanyType.NYCY);
		id_typeMap.put(-1, CompanyType.GCL);
		id_typeMap.put(111111, CompanyType.JT);
		id_typeMap.put(-1, CompanyType.BYQC);
		id_typeMap.put(-1, CompanyType.GJMYCTGS);
		id_typeMap.put(-1, CompanyType.ZTFGS);
		id_typeMap.put(-1, CompanyType.KJHGQ);
		id_typeMap.put(-1, CompanyType.DQZJFGS);
		id_typeMap.put(-1, CompanyType.DLZDHGS);
		id_typeMap.put(-1, CompanyType.SKGS);
		id_typeMap.put(-1, CompanyType.XSZX);
		id_typeMap.put(-1, CompanyType.XDWLGS);
		id_typeMap.put(-1, CompanyType.DLKCSJGS);
		id_typeMap.put(-1, CompanyType.XLGGS);
		id_typeMap.put(-1, CompanyType.GNCTB);
		id_typeMap.put(-1, CompanyType.DLAZB);
		id_typeMap.put(-1, CompanyType.ZXGS);
		id_typeMap.put(-1, CompanyType.HXGS);
		id_typeMap.put(-1, CompanyType.TBDG_YD_NYYXGS);
		id_typeMap.put(-1, CompanyType.SBWYGS);
