	...
	public @ResponseBody byte[] getByqnwbzlztqk(HttpServletRequest request,
		...
		if (all){
			...
			if (yjType == YDJDType.JD){
				result = byqnwbzlztqkService.getJdNbzlwtfl(d);
			}else{
				result = byqnwbzlztqkService.getYdNbzlwtfl(d);
			}
		}else{
			...
			if (yjType == YDJDType.JD){
				result = byqnwbzlztqkService.getJdNbzlwtfl(d, company);
			}else{
				result = byqnwbzlztqkService.getYdNbzlwtfl(d, company);
			}
		}
