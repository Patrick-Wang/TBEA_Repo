	...
	public @ResponseBody byte[] getByqnwbzlztqk(HttpServletRequest request,
		...
		if (all){
			...
			if (yjType == YDJDType.JD){
				result = xlnwbzlztqkService.getJdNbzlwtfl(d);
			}else{
				result = xlnwbzlztqkService.getYdNbzlwtfl(d); 
			}
		}else{
			...
			if (yjType == YDJDType.JD){
				result = xlnwbzlztqkService.getJdNbzlwtfl(d, company);
			}else{
				result = xlnwbzlztqkService.getYdNbzlwtfl(d, company);
			}
		}
