...
class BMDepartment extends AbstractOrganization {
	...
	public BMDepartment() {
		append(getCompany(CompanyType.SB, 1)
				...
				getCompany(CompanyType.XL, 5)
				.append(getCompany(CompanyType.XL_TYDXXMGS,501))
				.append(getCompany(CompanyType.XL_JNDXXMGS,502))
