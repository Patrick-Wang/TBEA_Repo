...
@Entity
@Table(name = "ydzbfdw")
public class YDZBFDW extends AbstractReadWriteEntity implements Serializable {
	...
	public Double getByyjwcz() {
		return byyjwcz;
	}

	public void setByyjwcz(Double byyjwcz) {
		this.byyjwcz = byyjwcz;
	}
	...
	public Double getNdljjhz() {
		return ndljjhz;
	}

	public void setNdljjhz(Double ndljjhz) {
		this.ndljjhz = ndljjhz;
	}
	...
	public String toString() {
		return "YDZBFDW [id=" + getId() + ", ny=" + ny + ", qybh=" + qybh
				+ ", zbbh=" + zbbh + ", zbmc=" + zbmc + ", byjhz=" + byjhz
				+ ", byyjwcz=" + byyjwcz + ", bywcz=" + bywcz + ", jhwcl="
				+ jhwcl + ", sywcz=" + sywcz + ", jsyzzb=" + jsyzzb
				+ ", sjdpjz=" + sjdpjz + ", jjzzzb=" + jjzzzb + ", qnpjz="
				+ qnpjz + ", jjzzzb1=" + jjzzzb1 + ", qntqz=" + qntqz
				+ ", jtqzzb=" + jtqzzb + ", jdjh=" + jdjh + ", jdlj=" + jdlj
				+ ", jdwcl=" + jdwcl + ", qntqjdwc=" + qntqjdwc + ", jqntqzzb="
				+ jqntqzzb + ", sjdz=" + sjdz + ", jsjdzzb=" + jsjdzzb
				+ ", ndjhz=" + ndjhz + ", ndljwcz=" + ndljwcz + ", ndljjhz="
				+ ndljjhz + ", ndwcl=" + ndwcl + ", qntqlj=" + qntqlj
				+ ", jqntqljzzb=" + jqntqljzzb + ", rowid=" + rowid + ", name="
				+ name + "]";
	}
