package com.tbea.ic.operation.controller.servlet.nwbzlqk.wbzlwttjqk.byqwbzlwttjqk;
...
@Controller
@RequestMapping(value = "byqwbzlwttjqk")
public class ByqwbzlwttjqkServlet {
	...
	public @ResponseBody byte[] getByqnbzlwttjqk(HttpServletRequest request,
		...
		List<List<String>> result = byqnwbzlztqkService.getWbzlwttjqk(d, company, zts);
