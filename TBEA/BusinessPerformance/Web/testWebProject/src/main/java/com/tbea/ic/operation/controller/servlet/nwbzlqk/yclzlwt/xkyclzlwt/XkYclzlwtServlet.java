package com.tbea.ic.operation.controller.servlet.nwbzlqk.yclzlwt.xkyclzlwt;
...
@Controller
@RequestMapping(value = "xkyclzlwt")
public class XkYclzlwtServlet {
	...
	public @ResponseBody byte[] getXknwbzlztqk(HttpServletRequest request,
		...
		if (comp == CompanyType.BYQCY){
			...
			if (yjType == YDJDType.JD){
				result = xknwbzlztqkService.getJdYclzlwt(d, zts);
			}else{
				result = xknwbzlztqkService.getYdYclzlwt(d, zts);
			}
			wis = xknwbzlztqkService.getWaveItemsYclzlwt(d, yjType, zts);
		}else{

			if (yjType == YDJDType.JD){
				result = xknwbzlztqkService.getJdYclzlwt(d, company, zts);
			}else{
				result = xknwbzlztqkService.getYdYclzlwt(d, company, zts);
			}
			wis = xknwbzlztqkService.getWaveItemsYclzlwt(d, yjType, company, zts);
		}
