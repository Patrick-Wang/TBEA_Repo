...
public class YdsjWithoutChYsRsPipeFilter implements IPipeFilter {
	...
	Date dateStart;
	Date dateEnd;
	public YdsjWithoutChYsRsPipeFilter(int col, SJZBAccumulator accumulator, Date dateStart, Date dateEnd) {
		this.col = col;
