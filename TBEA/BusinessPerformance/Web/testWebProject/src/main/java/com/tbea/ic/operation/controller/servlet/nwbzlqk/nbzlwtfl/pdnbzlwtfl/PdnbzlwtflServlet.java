	...
	public @ResponseBody byte[] getByqnwbzlztqk(HttpServletRequest request,
		...
		if (all){
			...
			if (yjType == YDJDType.JD){
				result = pdnwbzlztqkService.getJdNbzlwtfl(d);
			}else{
				result = pdnwbzlztqkService.getYdNbzlwtfl(d);
			}
		}else{
			...
			if (yjType == YDJDType.JD){
				result = pdnwbzlztqkService.getJdNbzlwtfl(d, company);
			}else{
				result = pdnwbzlztqkService.getYdNbzlwtfl(d, company);
			}
		}
