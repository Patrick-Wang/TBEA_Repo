	...
	public @ResponseBody byte[] getByqnwbzlztqk(HttpServletRequest request,
		...
		if (all){
			...
			if (yjType == YDJDType.JD){
				result = pdnwbzlztqkService.getJdWbzlwtfl(d);
			}else{
				result = pdnwbzlztqkService.getYdWbzlwtfl(d);
			}
		}else{
			...
			if (yjType == YDJDType.JD){
				result = pdnwbzlztqkService.getJdWbzlwtfl(d, company);
			}else{
				result = pdnwbzlztqkService.getYdWbzlwtfl(d, company);
			}
		}
