	...
	public @ResponseBody byte[] getByqnwbzlztqk(HttpServletRequest request,
		...
		if (all){
			...
			if (yjType == YDJDType.JD){
				result = pdnwbzlztqkService.getJdYsazzlwt(d);
			}else{
				result = pdnwbzlztqkService.getYdYsazzlwt(d);
			}
			wis = pdnwbzlztqkService.getWaveItemsYsazzlwt(d, yjType);
		}else{
			CompanyType comp = CompanySelection.getCompany(request);
			Company company = companyManager.getVirtualCYOrg().getCompany(comp);
			
			if (yjType == YDJDType.JD){
				result = pdnwbzlztqkService.getJdYsazzlwt(d, company);
			}else{
				result = pdnwbzlztqkService.getYdYsazzlwt(d, company);
			}
			wis = pdnwbzlztqkService.getWaveItemsYsazzlwt(d, yjType, company);
		}
