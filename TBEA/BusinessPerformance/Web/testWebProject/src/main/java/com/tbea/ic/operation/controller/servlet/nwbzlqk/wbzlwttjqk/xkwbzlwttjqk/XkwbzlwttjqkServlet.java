package com.tbea.ic.operation.controller.servlet.nwbzlqk.wbzlwttjqk.xkwbzlwttjqk;
...
@Controller
@RequestMapping(value = "xkwbzlwttjqk")
public class XkwbzlwttjqkServlet {
	...
	public @ResponseBody byte[] getXknbzlwttjqk(HttpServletRequest request,
		...
		List<List<String>> result = xknwbzlztqkService.getWbzlwttjqk(d, company, zts);
