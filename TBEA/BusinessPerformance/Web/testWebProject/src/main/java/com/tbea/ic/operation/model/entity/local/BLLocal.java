...
public class BLLocal extends AbstractReadWriteEntity implements Serializable {
	...
	public String toString() {
		return "BLLocal [id=" + getId() + ", gxrq=" + gxrq + ", blbh=" + blbh + ", htbh=" + htbh
				+ ", blrq=" + blrq + ", kxxz=" + kxxz + ", blje=" + blje
				+ ", bldqr=" + bldqr + ", blhkje=" + blhkje + ", blye=" + blye
