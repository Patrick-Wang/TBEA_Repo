...
<head>
	...
	<script src="../jsp/jygkzzy/ch_chjgjnh_template.js" type="text/javascript"></script>	

    <script type="text/javascript">
       	var view = jygk_zzy_ch_chjgjnh.View.getInstance();
        (function () {
    ...
    <title>${year}年${month}月存货结构及内涵</title>
