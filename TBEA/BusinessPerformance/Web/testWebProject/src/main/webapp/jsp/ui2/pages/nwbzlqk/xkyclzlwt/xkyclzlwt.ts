...
module plugin {
    export let xkyclzlwt : number = framework.basic.endpoint.lastId();
}
declare var echarts;
module nwbzlqk {
    export module xkyclzlwt {
        ...
        class ShowView extends ZlPluginView {
            ...
            private mAjax:Util.Ajax = new Util.Ajax("/BusinessManagement/xkyclzlwt/update.do", false);
            private mDt: string;
            private mCompType:Util.CompanyType;

            getId():number {
                return plugin.xkyclzlwt;
            }
            ...
            pluginGetExportUrl(date:string, compType:Util.CompanyType):string {
                return "/BusinessManagement/xkyclzlwt/export.do?" + Util.Ajax.toUrlParam({
                        date: date,
                        companyId:compType,
                        ydjd:this.mYdjdType
                 });
