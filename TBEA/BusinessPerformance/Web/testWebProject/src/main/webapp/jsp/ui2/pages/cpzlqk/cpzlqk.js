...
(function (cpzlqk) {
    ...
    var CpzlqkFrameView = /** @class */ (function (_super) {
        __extends(CpzlqkFrameView, _super);
        function CpzlqkFrameView() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.isCompanySupported = false;
            _this.mAjaxApprove = new Util.Ajax("/BusinessManagement/cpzlqk/doApprove.do", false);
            _this.mAjaxYclApprove = new Util.Ajax("/BusinessManagement/report/yclhglqktjZlDoApprove.do", false);
            _this.mAjaxAuth = new Util.Ajax("/BusinessManagement/cpzlqk/auth.do", false);
            return _this;
        }
        ...
        CpzlqkFrameView.prototype.onUpdateComment = function (comment, zt) {
            ...
            if (pageType == cpzlqk.PageType.APPROVE) { //approve
            ...
            else if (pageType == cpzlqk.PageType.ENTRY) { //submit
                $("#approveComment").hide();
                $("#approveComment1").hide();
                $("#approveComment2").hide();
                $("#approveComment3").hide();
            ...
            else if (pageType == cpzlqk.PageType.SHOW) { //show
                $("#approveComment").hide();
                $("#approveComment1").hide();
                $("#approveComment2").hide();
                $("#approveComment3").hide();
