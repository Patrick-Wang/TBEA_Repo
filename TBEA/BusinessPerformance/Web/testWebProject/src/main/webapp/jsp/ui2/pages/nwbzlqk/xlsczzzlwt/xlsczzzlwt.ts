...
module plugin {
    export let xlsczzzlwt : number = framework.basic.endpoint.lastId();
}
declare var echarts;
module nwbzlqk {
    export module xlsczzzlwt {
        ...
        class ShowView extends ZlPluginView {
            ...
            private mAjax:Util.Ajax = new Util.Ajax("/BusinessManagement/xlsczzzlwt/update.do", false);
            private mDt: string;
