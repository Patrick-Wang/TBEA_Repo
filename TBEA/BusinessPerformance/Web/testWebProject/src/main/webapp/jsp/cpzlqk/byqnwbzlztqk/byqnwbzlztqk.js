...
var plugin;
(function (plugin) {
    plugin.byqnwbzlztqk = framework.basic.endpoint.lastId();
})(plugin || (plugin = {}));
var cpzlqk;
(function (cpzlqk) {
    var byqnwbzlztqk;
    (function (byqnwbzlztqk) {
        ...
        var ShowView = (function (_super) {
            ...
            function ShowView() {
                ...
                this.mAjax = new Util.Ajax("../byqnwbzlztqk/update.do", false);
            ...
            ShowView.prototype.pluginGetExportUrl = function (date, compType) {
                return "../byqnwbzlztqk/export.do?" + Util.Ajax.toUrlParam({
                    date: date,
                    companyId: compType,
                    ydjd: this.mYdjdType
                });
    ...
    })(byqnwbzlztqk = cpzlqk.byqnwbzlztqk || (cpzlqk.byqnwbzlztqk = {}));
})(cpzlqk || (cpzlqk = {}));
