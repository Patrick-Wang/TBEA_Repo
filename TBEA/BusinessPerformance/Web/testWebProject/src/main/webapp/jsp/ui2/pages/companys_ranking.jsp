...
<script
	src="${pageContext.request.contextPath}/jsp/ui2/pages/companys_ranking.js"></script>
				...
				<div class="page-header position-relative">
					<div class="header-title">
						...
						<select id="company-type" class="pull-left">
								<option value="1" selected="selected">经营单位排名</option>
								<option value="2" >项目公司排名</option>
						</select>

						<select id="report-type" class="pull-left">	</select>
