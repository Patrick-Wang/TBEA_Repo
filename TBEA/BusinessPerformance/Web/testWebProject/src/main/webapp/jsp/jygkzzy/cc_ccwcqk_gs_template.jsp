...
<script src="../jsp/jygkzzy/cc_ccwcqk_gs_template.js" type="text/javascript"></script>
...
<script type="text/javascript">
	var view = cc_ccwcqk_gs_template.View.getInstance();
    (function () {
		$(document).ready(function () {
          	view.initBglxViewSelect({bglxId : "div_bglx", curbglx : "20014"});
            $("#bglx").val("20014");
            view.updateEntry(); 
			/*view.initInstance({
				tableId : "table",
