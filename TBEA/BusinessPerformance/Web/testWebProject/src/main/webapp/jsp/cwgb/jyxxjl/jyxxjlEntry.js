...
(function (pluginEntry) {
    pluginEntry.jyxxjl = framework.basic.endpoint.lastId();
})(pluginEntry || (pluginEntry = {}));
var cwgb;
(function (cwgb) {
    var jyxxjlEntry;
    (function (jyxxjlEntry) {
        ...
        var EntryView = (function (_super) {
            ...
            function EntryView() {
                ...
                this.mAjaxUpdate = new Util.Ajax("../jyxxjl/entry/update.do", false);
                this.mAjaxSave = new Util.Ajax("../jyxxjl/entry/save.do", false);
                this.mAjaxSubmit = new Util.Ajax("../jyxxjl/entry/submit.do", false);
            }
    ...
    })(jyxxjlEntry = cwgb.jyxxjlEntry || (cwgb.jyxxjlEntry = {}));
})(cwgb || (cwgb = {}));
