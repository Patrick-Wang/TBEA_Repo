    ...
    (function (cpclwcqkEntry) {
        ...
        var EntryView = (function (_super) {
            ...
            function EntryView() {
                ...
                _this.mAjaxUpdate = new Util.Ajax("/BusinessManagement/cpclwcqk/entry/update.do", false);
                _this.mAjaxSave = new Util.Ajax("/BusinessManagement/cpclwcqk/entry/save.do", false);
                _this.mAjaxSubmit = new Util.Ajax("/BusinessManagement/cpclwcqk/entry/submit.do", false);
                return _this;
            }
