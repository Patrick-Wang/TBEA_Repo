    ...
    var JQGridAssistantFactory = (function () {
        ...
        JQGridAssistantFactory.createFlatTable = function (gridName, title) {
            ...
            for (var i = 0; i < title.length; ++i) {
                if (i == 0) {
                    nodes.push(new JQTable.Node(title[i], "_" + i, true, 0 /* Left */, 85));
                }
                else {
                    nodes.push(new JQTable.Node(title[i], "_" + i, false, 1 /* Right */, 85));
                }
            }
        ...
        JQGridAssistantFactory.createQnjhTable = function (gridName, title, ids) {
            ...
            for (var i = 0; i < title.length; ++i) {
                if (i < 1) {
                    nodes.push(new JQTable.Node(title[i], ids[i], true, 0 /* Left */, 85));
                }
                else {
                    nodes.push(new JQTable.Node(title[i], ids[i], false, 1 /* Right */, 85));
                }
            }
            return new JQTable.JQGridAssistant(nodes, gridName);
        };
