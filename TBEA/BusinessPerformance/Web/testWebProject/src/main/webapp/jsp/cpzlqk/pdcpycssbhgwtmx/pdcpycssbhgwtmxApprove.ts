...
module cpzlqk {
    export module pdcpycssbhgwtmxApprove {
        ...
        class ApproveView extends ZlApprovePluginView {
            ...
            private mAjaxUpdate:Util.Ajax = new Util.Ajax("../pdcpycssbhgwtmx/approve/update.do", false);
            private mAjaxApprove:Util.Ajax = new Util.Ajax("../pdcpycssbhgwtmx/approve/approve.do", false);
            private mAjaxUnapprove:Util.Ajax = new Util.Ajax("../pdcpycssbhgwtmx/approve/unapprove.do", false);
