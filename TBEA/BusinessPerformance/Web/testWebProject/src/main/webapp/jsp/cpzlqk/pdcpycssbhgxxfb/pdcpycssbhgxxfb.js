...
var plugin;
(function (plugin) {
    plugin.pdcpycssbhgxxfb = framework.basic.endpoint.lastId();
    plugin.pdybysqfysxxfb = framework.basic.endpoint.lastId();
    plugin.pdybyspbcpxxfb = framework.basic.endpoint.lastId();
})(plugin || (plugin = {}));
var cpzlqk;
(function (cpzlqk) {
    var pdcpycssbhgxxfb;
