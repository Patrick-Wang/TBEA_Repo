...
<head>
	...
	<script src="../jsp/jygkzzy/ch_zljj_template.js" type="text/javascript"></script>	

    <script type="text/javascript">
       	var view = jygk_zzy_ch_zljj.View.getInstance();
        (function () {
    ...
    <title>${year}年${month}月账龄结构</title>
