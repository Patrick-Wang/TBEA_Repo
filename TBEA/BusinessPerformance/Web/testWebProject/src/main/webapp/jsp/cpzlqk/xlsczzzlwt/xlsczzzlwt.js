...
var plugin;
(function (plugin) {
    plugin.xlsczzzlwt = framework.basic.endpoint.lastId();
})(plugin || (plugin = {}));
var cpzlqk;
(function (cpzlqk) {
    var xlsczzzlwt;
    (function (xlsczzzlwt) {
        ...
        var ShowView = (function (_super) {
            ...
            function ShowView() {
                ...
                this.mAjax = new Util.Ajax("../xlsczzzlwt/update.do", false);
            ...
            ShowView.prototype.pluginGetExportUrl = function (date, compType) {
                return "../xlsczzzlwt/export.do?" + Util.Ajax.toUrlParam({
                    date: date,
                    companyId: compType,
                    ydjd: this.mYdjdType
                });
    ...
    })(xlsczzzlwt = cpzlqk.xlsczzzlwt || (cpzlqk.xlsczzzlwt = {}));
})(cpzlqk || (cpzlqk = {}));
