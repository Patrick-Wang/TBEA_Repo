...
<script src="../jsp/jygkzzy/fx_cpylsp_hqlyddzl.js" type="text/javascript"></script>
...
<script type="text/javascript">
	var view = fx_cpylsp_hqlyddzl.View.getInstance();
      (function () {
				...
				<Table>
					<tr>
						...
						<td>
							<div id="company"></div>
						<td>
						<td><input id="read" type="button" value="选择"
							style="width: 80px; margin-left: 10px;" onclick="view.read()"></input>
						</td>
					</tr>
				</Table>
			</td>
