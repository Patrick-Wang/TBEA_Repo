    ...
    (function (basicEntry) {
        ...
        var EntryView = (function (_super) {
            ...
            function EntryView() {
                ...
                this.mAjaxUpdate = new Util.Ajax("../basic/entry/update.do", false);
                this.mAjaxSave = new Util.Ajax("../basic/entry/save.do", false);
                this.mAjaxSubmit = new Util.Ajax("../basic/entry/submit.do", false);
            }
