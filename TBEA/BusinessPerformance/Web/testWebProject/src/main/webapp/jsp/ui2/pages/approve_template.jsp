...
<script
	src="${pageContext.request.contextPath}/jsp/ui2/pages/approve_template.js"></script>
			...
			<div class="page-content">
				...
				<div class="page-header position-relative">
					<div class="header-title">
						...
						<div class="btn btn-default unapprove-area pull-right" style="display:none"
							onclick="view.unapprove()">
							反审核
						</div>
						<div class="btn btn-default approve-area pull-right" style="display:none"
				...
				<div class="page-body">
					<div class="row">
						<div class="col-lg-12 col-sm-12 col-xs-12">
							<div class="well approve-area">
								<span style="font-weight: bold">未审核数据</span>
								<div id="table_approve"></div>
							</div>
							<div class="well unapprove-area">
								<span style="font-weight: bold">已审核数据</span>
								<div id="table_unapprove"></div>
							</div>
							<div  id="nothing"  class="well" style="display: none;">
								<span style="font-weight: bold">没有可审核的数据</span>
							</div>
						</div>
					</div>
				</div>
