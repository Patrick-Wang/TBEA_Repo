...
module plugin {
    export let byqsczzzlwtxxxx : number = framework.basic.endpoint.lastId();
}
declare var echarts;
module nwbzlqk {
    export module byqsczzzlwtxxxx {
        ...
        class JQGridAssistantFactory {
            public static createZtTable(gridName:string, ydjd:YDJDType):JQTable.JQGridAssistant {
                return new JQTable.JQGridAssistant([
                    ...
                    Node.create({name :  ydjd == YDJDType.YD ? "月度" : "当期"}),
                    Node.create({name :  ydjd == YDJDType.YD ? "年度" : "去年同期"})
                ], gridName);
            }
        ...
        class ShowView extends ZlPluginView {
            ...
            private mAjax:Util.Ajax = new Util.Ajax("/BusinessManagement/byqsczzzlwtxxxx/update.do", false);
            private mDt: string;
