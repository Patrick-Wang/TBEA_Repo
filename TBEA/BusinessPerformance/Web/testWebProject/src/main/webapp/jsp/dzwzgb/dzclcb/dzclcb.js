...
(function (dzwzgb) {
    ...
    (function (dzclcb) {
        ...
        var DzclcbView = (function (_super) {
            __extends(DzclcbView, _super);
            function DzclcbView() {
                _super.apply(this, arguments);
                this.mAjax = new Util.Ajax("dzclcb/update.do", false);
            }
            DzclcbView.prototype.getId = function () {
                return plugin.dzclcb;
            };
            DzclcbView.prototype.pluginGetExportUrl = function (date, compType) {
                return "dzclcb/export.do?" + Util.Ajax.toUrlParam({
                    date: date,
                    companyId: compType
                });
            };
            DzclcbView.prototype.option = function () {
                return this.mOpt;
            };
            DzclcbView.prototype.pluginUpdate = function (date, compType) {
                var _this = this;
                this.mDt = date;
