    ...
    (function (yszkkxxz) {
        ...
        var SimplePluginEntryView = (function (_super) {
            ...
            function SimplePluginEntryView(id) {
                _super.call(this, id);
                this.mAjaxUpdate = new Util.Ajax("/BusinessManagement/yszkgb//yszkkxxz/entry/update.do", false);
                this.mAjaxSave = new Util.Ajax("/BusinessManagement/yszkgb/yszkkxxz/entry/save.do", false);
                this.mAjaxSubmit = new Util.Ajax("/BusinessManagement/yszkgb/yszkkxxz/entry/submit.do", false);
            }
