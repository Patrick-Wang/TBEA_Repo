...
(function (Util) {
    (function (CompanyType) {
        ...
        CompanyType[CompanyType["BYQC"] = 20] = "BYQC";
        CompanyType[CompanyType["GJMYCTGS"] = 21] = "GJMYCTGS";
        CompanyType[CompanyType["ZTFGS"] = 22] = "ZTFGS";
        CompanyType[CompanyType["KJHGQ"] = 23] = "KJHGQ";
        CompanyType[CompanyType["DQZJFGS"] = 24] = "DQZJFGS";
        CompanyType[CompanyType["DLZDHGS"] = 25] = "DLZDHGS";
        CompanyType[CompanyType["SKGS"] = 26] = "SKGS";
        CompanyType[CompanyType["XSZX"] = 27] = "XSZX";
        CompanyType[CompanyType["XDWLGS"] = 28] = "XDWLGS";
        CompanyType[CompanyType["DLKCSJGS"] = 29] = "DLKCSJGS";
        CompanyType[CompanyType["XLGGS"] = 30] = "XLGGS";
        CompanyType[CompanyType["GNCTB"] = 31] = "GNCTB";
        CompanyType[CompanyType["DLAZB"] = 32] = "DLAZB";
        CompanyType[CompanyType["ZXGS"] = 33] = "ZXGS";
        CompanyType[CompanyType["HXGS"] = 34] = "HXGS";
        CompanyType[CompanyType["TBDG_YD_NYYXGS"] = 35] = "TBDG_YD_NYYXGS";
        CompanyType[CompanyType["SBWYGS"] = 36] = "SBWYGS";
        CompanyType[CompanyType["DQFGS"] = 37] = "DQFGS";
        CompanyType[CompanyType["HNGJWLGS"] = 38] = "HNGJWLGS";
        CompanyType[CompanyType["HNGCGS"] = 39] = "HNGCGS";
        CompanyType[CompanyType["ZYGS"] = 40] = "ZYGS";
        CompanyType[CompanyType["HNZNDQGS"] = 41] = "HNZNDQGS";
        CompanyType[CompanyType["NJZNDQGS"] = 42] = "NJZNDQGS";
        CompanyType[CompanyType["HNYLGS"] = 43] = "HNYLGS";
        CompanyType[CompanyType["TBGS"] = 44] = "TBGS";
        CompanyType[CompanyType["ZTGS"] = 45] = "ZTGS";
        CompanyType[CompanyType["XBGS"] = 46] = "XBGS";
        CompanyType[CompanyType["GJCTGCGS"] = 47] = "GJCTGCGS";
        CompanyType[CompanyType["GNGCJXGS"] = 48] = "GNGCJXGS";
        CompanyType[CompanyType["XJXTGJWLMYGS"] = 49] = "XJXTGJWLMYGS";
