...
/* 		ajaxInit = new Util.Ajax(
		...
		window.data = {
				...
				scqypm :{
					sbdztqy:289635,
					gnzb:"68%",
					gnsc: [["公司1","98652"],["公司2","88693"],["公司3","76398"],["公司4","72681"],["公司5","62584"],["公司6","33598"]],
					gjsc: [["公司6","98753"],["公司4","75631"],["公司1","73215"],["公司4","69852"],["公司2","56487"],["公司5","26895"]]
				},
				jydw : [
					[{
						ndjh:(Math.random() * 100000).toFixed(0),
						ndlj:(Math.random() * 50000).toFixed(0),
						qntq:(Math.random() * 50000).toFixed(0)
					},{
						ndjh:(Math.random() * 100000).toFixed(0),
						ndlj:(Math.random() * 50000).toFixed(0),
						qntq:(Math.random() * 50000).toFixed(0)
		...
		function bindPart1Data() {
			...
			$("#yszk-zq")
					.on("click",
							function() {
								...
								window.open("/BusinessManagement/redirector/redirect.do?url=jsp/ui2/dashboard/test/yszk/yszk.jsp&breads="
			...
			$("#lrze-zq").on("click",
					function() {
						...
						window.open("/BusinessManagement/redirector/redirect.do?url=jsp/ui2/dashboard/test/lrze/lrze.jsp&breads="
								+ JSON.stringify(breads));
						breads = breads.slice(0, breads.length - 1);
					});
		...
		function bindPart2Data() {
			...
			function getChartOpt(index) {
				...
				var d1_ticks = [ [ 1, '公司1' ], [ 2, '公司2' ], [ 3, '公司3' ],
						[ 4, '公司4' ], [ 5, '公司5' ], [ 6, '公司6' ], [ 7, '公司7' ],
						[ 8, '公司8' ], [ 9, '公司9' ], [ 10, '公司10' ]];
