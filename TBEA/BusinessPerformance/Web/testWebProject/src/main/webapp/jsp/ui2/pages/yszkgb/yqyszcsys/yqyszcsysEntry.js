    ...
    (function (yqyszcsys) {
        ...
        var SimplePluginEntryView = (function (_super) {
            ...
            function SimplePluginEntryView(id) {
                ...
                _this.mAjaxUpdate = new Util.Ajax("/BusinessManagement/yszkgb//yqyszcsys/entry/update.do", false);
                _this.mAjaxSave = new Util.Ajax("/BusinessManagement/yszkgb/yqyszcsys/entry/save.do", false);
                _this.mAjaxSubmit = new Util.Ajax("/BusinessManagement/yszkgb/yqyszcsys/entry/submit.do", false);
                return _this;
            }
