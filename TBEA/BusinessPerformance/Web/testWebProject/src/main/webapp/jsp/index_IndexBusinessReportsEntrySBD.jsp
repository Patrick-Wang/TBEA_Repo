...
<div>
	<h3>
		输变电产业经营管报录入<a name="sbdcyjygbEntry"> </a>
	</h3>
	<div class="section">
		<div class="thumb3">
			<ul class="slides">
				<li><a href="../dzwzgb/entry.do" target="_blank"><img
						src="../images/charts/bar5.png"> <span><strong>大宗物资管报录入</strong></span></a>
				</li>
				<li><a href="../wlydd/entry.do" target="_blank"><img
						src="../images/charts/bar6.png"> <span><strong>未履约订单情况录入</strong></span></a>
				</li>

				<li><a href="../sbdczclwcqk/entry.do" target="_blank"><img
						src="../images/charts/bar7.png"> <span><strong>输变电产值/产量完成情况录入</strong></span></a>
				</li>
				<li><a href="../sbdscqyqk/entry.do" target="_blank"><img
						src="../images/charts/bar8.png"> <span><strong>输变电市场签约情况录入</strong></span></a>
				</li>
				<li><a href="../wgcpqk/entry.do" target="_blank"><img
						src="../images/charts/bar9.png"> <span><strong>完工产品情况录入</strong></span></a>
				</li>
				<%--
