...
<script src="../jsp/jygkzzy/fx_jkcb_ztnhqk_xl_template.js" type="text/javascript"></script>
...
<script type="text/javascript">
	var view = fx_jkcb_ztnhqk_xl_template.View.getInstance();
    (function () {
		$(document).ready(function () {
          	view.initBglxViewSelect({bglxId : "div_bglx", curbglx : "20010"});
            $("#bglx").val("20010");
            view.updateEntry(); 
			/*view.initInstance({
				tableId : "table",
