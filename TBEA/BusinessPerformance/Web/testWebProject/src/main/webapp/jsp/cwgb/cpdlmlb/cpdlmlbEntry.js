...
(function (pluginEntry) {
    pluginEntry.cpdlmlb = framework.basic.endpoint.lastId();
})(pluginEntry || (pluginEntry = {}));
var cwgb;
(function (cwgb) {
    var cpdlmlbEntry;
    (function (cpdlmlbEntry) {
        ...
        var EntryView = (function (_super) {
            ...
            function EntryView() {
                ...
                this.mAjaxUpdate = new Util.Ajax("../cpdlmlb/entry/update.do", false);
                this.mAjaxSave = new Util.Ajax("../cpdlmlb/entry/save.do", false);
                this.mAjaxSubmit = new Util.Ajax("../cpdlmlb/entry/submit.do", false);
            }
    ...
    })(cpdlmlbEntry = cwgb.cpdlmlbEntry || (cwgb.cpdlmlbEntry = {}));
})(cwgb || (cwgb = {}));
