...
var plugin;
(function (plugin) {
    plugin.byqyclzlwt = framework.basic.endpoint.lastId();
})(plugin || (plugin = {}));
var cpzlqk;
(function (cpzlqk) {
    var byqyclzlwt;
    (function (byqyclzlwt) {
        ...
        var ShowView = (function (_super) {
            ...
            function ShowView() {
                ...
                this.mAjax = new Util.Ajax("../byqyclzlwt/update.do", false);
            ...
            ShowView.prototype.pluginGetExportUrl = function (date, compType) {
                return "../byqyclzlwt/export.do?" + Util.Ajax.toUrlParam({
                    date: date,
                    companyId: compType,
                    ydjd: this.mYdjdType
                });
    ...
    })(byqyclzlwt = cpzlqk.byqyclzlwt || (cpzlqk.byqyclzlwt = {}));
})(cpzlqk || (cpzlqk = {}));
