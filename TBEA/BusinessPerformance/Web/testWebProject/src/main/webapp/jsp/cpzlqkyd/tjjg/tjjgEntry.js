...
(function (pluginEntry) {
    pluginEntry.tjjg = framework.basic.endpoint.lastId();
...
(function (cpzlqkyd) {
    ...
    (function (tjjgEntry) {
        ...
        var EntryView = (function (_super) {
            ...
            function EntryView() {
                ...
                this.mAjaxUpdate = new Util.Ajax("../tjjg/entry/update.do", false);
                this.mAjaxSave = new Util.Ajax("../tjjg/entry/save.do", false);
                this.mAjaxSubmit = new Util.Ajax("../tjjg/entry/submit.do", false);
            }
    ...
    })(tjjgEntry = cpzlqkyd.tjjgEntry || (cpzlqkyd.tjjgEntry = {}));
})(cpzlqkyd || (cpzlqkyd = {}));
