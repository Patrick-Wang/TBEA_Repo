...
var plugin;
(function (plugin) {
    plugin.xkwbzlwtfl = framework.basic.endpoint.lastId();
})(plugin || (plugin = {}));
var nwbzlqk;
(function (nwbzlqk) {
    var xkwbzlwtfl;
    (function (xkwbzlwtfl) {
        ...
        var ShowView = /** @class */ (function (_super) {
            ...
            function ShowView() {
                ...
                _this.mAjax = new Util.Ajax("/BusinessManagement/xkwbzlwtfl/update.do", false);
                return _this;
            }
            ShowView.prototype.getId = function () {
                return plugin.xkwbzlwtfl;
            };
            ...
            ShowView.prototype.pluginGetExportUrl = function (date, compType) {
                return "/BusinessManagement/xkwbzlwtfl/export.do?" + Util.Ajax.toUrlParam({
                    date: date,
                    companyId: compType,
                    ydjd: this.mYdjdType
                });
    ...
    })(xkwbzlwtfl = nwbzlqk.xkwbzlwtfl || (nwbzlqk.xkwbzlwtfl = {}));
})(nwbzlqk || (nwbzlqk = {}));
