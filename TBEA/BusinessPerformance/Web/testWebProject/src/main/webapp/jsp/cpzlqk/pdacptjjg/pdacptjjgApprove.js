...
(function (pluginApprove) {
    pluginApprove.pdacptjjg = framework.basic.endpoint.lastId();
})(pluginApprove || (pluginApprove = {}));
var cpzlqk;
(function (cpzlqk) {
    var pdacptjjgApprove;
    (function (pdacptjjgApprove) {
        ...
        var ApproveView = (function (_super) {
            ...
            function ApproveView() {
                ...
                this.mAjaxUpdate = new Util.Ajax("../pdacptjjg/approve/update.do", false);
                this.mAjaxApprove = new Util.Ajax("../pdacptjjg/approve/approve.do", false);
                this.mAjaxUnapprove = new Util.Ajax("../pdacptjjg/approve/unapprove.do", false);
            }
            ApproveView.prototype.getId = function () {
                return pluginApprove.pdacptjjg;
            };
    ...
    })(pdacptjjgApprove = cpzlqk.pdacptjjgApprove || (cpzlqk.pdacptjjgApprove = {}));
})(cpzlqk || (cpzlqk = {}));
