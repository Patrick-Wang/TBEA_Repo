...
(function (jcycljg) {
    ...
    (function (gjyy) {
        ...
        var GjyyView = /** @class */ (function (_super) {
            __extends(GjyyView, _super);
            function GjyyView() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.mAjax = new Util.Ajax("/BusinessManagement/jcycljg/update.do?type=" + jcycljg.JcycljgType.GJYY, false);
                return _this;
            ...
            GjyyView.prototype.adjustSize = function () {
                _super.prototype.adjustSize.call(this);
                this.updateChart();
            };
            GjyyView.prototype.createJqassist = function () {
                var parent = this.$(this.option().tb);
                parent.empty();
