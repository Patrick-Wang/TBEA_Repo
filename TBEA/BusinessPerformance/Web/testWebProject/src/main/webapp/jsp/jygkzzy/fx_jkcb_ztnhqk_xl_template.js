...
var fx_jkcb_ztnhqk_xl_template;
(function (fx_jkcb_ztnhqk_xl_template) {
    ...
    var View = (function () {
        ...
        View.prototype.updateEntry = function () {
            ...
            this.mCondition.get({ entryType: "20010" })
                .then(function (data) {
                _this.initInstance({
                    tableId: "table",
                    dateId: "date",
    ...
    fx_jkcb_ztnhqk_xl_template.View = View;
})(fx_jkcb_ztnhqk_xl_template || (fx_jkcb_ztnhqk_xl_template = {}));
