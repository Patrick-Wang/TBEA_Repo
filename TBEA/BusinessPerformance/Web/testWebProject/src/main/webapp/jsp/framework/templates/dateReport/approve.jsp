...
<head>
    ...
    <script src="${pageContext.request.contextPath}/jsp/framework/templates/singleDateReport/approve.js"></script>
    <script src="${pageContext.request.contextPath}/jsp/framework/templates/dateReport/approve.js"></script>
    <title>${title}</title>
