...
var plugin;
(function (plugin) {
    plugin.byqsczzzlwt = framework.basic.endpoint.lastId();
})(plugin || (plugin = {}));
var nwbzlqk;
(function (nwbzlqk) {
    var byqsczzzlwt;
    (function (byqsczzzlwt) {
        ...
        var ShowView = /** @class */ (function (_super) {
            ...
            function ShowView() {
                ...
                _this.mAjax = new Util.Ajax("/BusinessManagement/byqsczzzlwt/update.do", false);
                return _this;
            ...
            ShowView.prototype.pluginGetExportUrl = function (date, compType) {
                return "/BusinessManagement/byqsczzzlwt/export.do?" + Util.Ajax.toUrlParam({
                    date: date,
                    companyId: compType,
                    ydjd: this.mYdjdType
                });
    ...
    })(byqsczzzlwt = nwbzlqk.byqsczzzlwt || (nwbzlqk.byqsczzzlwt = {}));
})(nwbzlqk || (nwbzlqk = {}));
