...
<script
	src="${pageContext.request.contextPath}/jsp/ui2/pages/wlyddqk/wlyddqk.js"></script>
				...
				<div class="page-header position-relative">
					<div class="header-title">
						<div id="headerHost" class="pull-left">
							...
							<div id="grid-export" class="btn btn-default" onclick="view.exportExcel('exportExcel')">
