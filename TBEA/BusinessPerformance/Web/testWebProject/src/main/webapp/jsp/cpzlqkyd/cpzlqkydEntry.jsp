...
<script src="${pageContext.request.contextPath}/jsp/cpzlqkyd/cpzlqkydEntry.js" type="text/javascript"></script>
<title>完工产品情况</title>
...
<body>
	...
	<Table id="frameTable" align="center" style="width:1200px">
		...
		<tr>
			<td id="plugin">
				<%@include file="tjjg/tjjgEntry.jsp"%>
				<%@include file="yylkvyscpycssbhg/yylkvyscpycssbhgEntry.jsp"%>
				<%@include file="pbcpycssbhg/pbcpycssbhgEntry.jsp"%>
			</td>
		</tr> 
		<tr>
			<td>
