module search {
    ...
    class TablePanel {
        ...
        updatePgSize() {
            ...
            let tbPager = 28;
            let rowHeight = 28;
            let wellPaddingTop = $("#table").parent().parent().css("padding-top").replace("px", "");
            let wellPaddingBottom = $("#table").parent().parent().css("padding-bottom").replace("px", "");
            ...
            let newPgSize = zeroDiv(bodyHeight - 22, rowHeight);
