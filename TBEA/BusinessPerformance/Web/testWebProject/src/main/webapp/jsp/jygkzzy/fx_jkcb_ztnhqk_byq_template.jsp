...
<script src="../jsp/jygkzzy/fx_jkcb_ztnhqk_byq_template.js" type="text/javascript"></script>
...
<script type="text/javascript">
	var view = fx_jkcb_ztnhqk_byq_template.View.getInstance();
    (function () {
		$(document).ready(function () {
          	view.initBglxViewSelect({bglxId : "div_bglx", curbglx : "20009"});
            $("#bglx").val("20009");
            view.updateEntry(); 
			/*view.initInstance({
				tableId : "table",
...
<select name="bglx" id="bglx" style="display:none">
	...
	<Table align="center" cellspacing="0" cellpadding="0">
		...
		<tr align="center">
			<td>
				<div style="padding-top:20px;font-size:25px" id="nodatatips">请选择需要查看的数据</div>
			</td>
		</tr>
		<tr >
			<td>
