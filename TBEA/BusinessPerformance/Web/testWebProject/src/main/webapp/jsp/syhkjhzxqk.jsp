...
<head>
    ...
    <script src="../jsp/syhkjhzxqk.js" type="text/javascript"></script>

    <script type="text/javascript">
    		var instance = syhkjhzxqk.View.newInstance();
            (function () {
    ...
    <title>${year}年${month}月 回款计划执行情况</title>
