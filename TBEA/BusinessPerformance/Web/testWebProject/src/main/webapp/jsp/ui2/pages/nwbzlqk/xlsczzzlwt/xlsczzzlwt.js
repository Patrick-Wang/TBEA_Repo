...
(function (nwbzlqk) {
    ...
    (function (xlsczzzlwt) {
        ...
        var ShowView = (function (_super) {
            ...
            function ShowView() {
                ...
                _this.mAjax = new Util.Ajax("/BusinessManagement/xlsczzzlwt/update.do", false);
                return _this;
            ...
            ShowView.prototype.pluginGetExportUrl = function (date, compType) {
                return "/BusinessManagement/xlsczzzlwt/export.do?" + Util.Ajax.toUrlParam({
                    date: date,
                    companyId: compType,
                    ydjd: this.mYdjdType
                });
    ...
    })(xlsczzzlwt = nwbzlqk.xlsczzzlwt || (nwbzlqk.xlsczzzlwt = {}));
})(nwbzlqk || (nwbzlqk = {}));
