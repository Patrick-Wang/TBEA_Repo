...
var plugin;
(function (plugin) {
    plugin.byqnbzlwtfl = framework.basic.endpoint.lastId();
})(plugin || (plugin = {}));
var nwbzlqk;
(function (nwbzlqk) {
    var byqnbzlwtfl;
    (function (byqnbzlwtfl) {
        ...
        var ShowView = (function (_super) {
            ...
            function ShowView() {
                ...
                _this.mAjax = new Util.Ajax("/BusinessManagement/byqnbzlwtfl/update.do", false);
                return _this;
            }
            ...
            ShowView.prototype.pluginGetExportUrl = function (date, compType) {
                return "/BusinessManagement/byqnbzlwtfl/export.do?" + Util.Ajax.toUrlParam({
                    date: date,
                    companyId: compType,
                    ydjd: this.mYdjdType
                });
    ...
    })(byqnbzlwtfl = nwbzlqk.byqnbzlwtfl || (nwbzlqk.byqnbzlwtfl = {}));
})(nwbzlqk || (nwbzlqk = {}));
