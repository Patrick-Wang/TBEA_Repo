...
module plugin {
    export let xknwbzlztqk : number = framework.basic.endpoint.lastId();
}
declare var echarts;
module nwbzlqk {
    export module xknwbzlztqk {
        ...
        class ShowView extends ZlPluginView {
            ...
            private mAjax:Util.Ajax = new Util.Ajax("/BusinessManagement/xknwbzlztqk/update.do", false);
            private mDt: string;
            ...
            pluginGetExportUrl(date:string, compType:Util.CompanyType):string {
                return "/BusinessManagement/xknwbzlztqk/export.do?" + Util.Ajax.toUrlParam({
                        date: date,
                        companyId:compType,
                        ydjd:this.mYdjdType
                 });
