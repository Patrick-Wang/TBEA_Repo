...
module plugin {
    export let xksjzlqk : number = framework.basic.endpoint.lastId();
}
declare var echarts;
module nwbzlqk {
    export module xksjzlqk {
        ...
        class ShowView extends ZlPluginView {
            ...
            private mAjax:Util.Ajax = new Util.Ajax("/BusinessManagement/xksjzlqk/update.do", false);
            private mDt: string;
            private mCompType:Util.CompanyType;

            getId():number {
                return plugin.xksjzlqk;
            }
            ...
            pluginGetExportUrl(date:string, compType:Util.CompanyType):string {
                return "/BusinessManagement/xksjzlqk/export.do?" + Util.Ajax.toUrlParam({
                        date: date,
                        companyId:compType,
                        ydjd:this.mYdjdType
                 });
