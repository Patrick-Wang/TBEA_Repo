    ...
    (function (nyzbscjgEntry) {
        ...
        var EntryView = /** @class */ (function (_super) {
            ...
            function EntryView() {
                ...
                _this.mAjaxUpdate = new Util.Ajax("/BusinessManagement/nyzbscjg/entry/update.do", false);
                _this.mAjaxSave = new Util.Ajax("/BusinessManagement/nyzbscjg/entry/save.do", false);
                _this.mAjaxSubmit = new Util.Ajax("/BusinessManagement/nyzbscjg/entry/submit.do", false);
                return _this;
            }
