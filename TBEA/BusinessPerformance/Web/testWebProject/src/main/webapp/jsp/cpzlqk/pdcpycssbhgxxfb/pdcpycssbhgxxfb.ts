...
module plugin {
    export let pdcpycssbhgxxfb : number = framework.basic.endpoint.lastId();
    export let pdybysqfysxxfb : number = framework.basic.endpoint.lastId();
    export let pdybyspbcpxxfb : number = framework.basic.endpoint.lastId();
}
