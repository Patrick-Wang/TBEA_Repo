...
<head>
	...
	<script src="../jsp/jygkzzy/fx_jkcb_cgjb_template.js" type="text/javascript"></script>	

    <script type="text/javascript">
       	var view = fx_jkcb_cgjb.View.getInstance();
        (function () {
    ...
    <title>${year}年${month}月采购降本</title>
