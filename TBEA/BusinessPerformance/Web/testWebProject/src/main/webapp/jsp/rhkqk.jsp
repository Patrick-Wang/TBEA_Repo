...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <script src="../jsp/rhkqk.js" type="text/javascript"></script>

    <script type="text/javascript">
    		var instance = rhkqk.View.newInstance();
            (function () {
    ...
    <title>${year}年${month}月 ${day}日 回款情况</title>
...
<body>
    <div class="header">
        <h1>${year}年${month}月 ${day}日 回款情况</h1>
    </div>
	  <Table align="center">
			<tr>
				<td>
