...
<script src="${pageContext.request.contextPath}/jsp/cwgb/cwgbdef.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/jsp/cwgb/cwgbEntry.js" type="text/javascript"></script>
<title>完工产品情况</title>
...
<body>
	...
	<Table id="frameTable" align="center" style="width:1200px">
		...
		<tr>
			<td id="plugin">
				<%@include file="yjsf/yjsfEntry.jsp"%>
				<%@include file="cpdlmlb/cpdlmlbEntry.jsp"%>
				<%@include file="jyxxjl/jyxxjlEntry.jsp"%>
			</td>
		</tr> 
		<tr>
			<td>
