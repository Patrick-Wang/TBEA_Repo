...
<script
	src="${pageContext.request.contextPath}/jsp/ui2/pages/wlyddqk/wlyddqkdef.js"></script>
<script
	src="${pageContext.request.contextPath}/jsp/ui2/pages/wlyddqk/wlyddqkEntry.js"></script>
				...
				<div class="page-body">
					<div class="row">
						<div class="col-lg-12 col-sm-12 col-xs-12">
							<%@include file="byqkglydd/byqkglyddEntry.jsp"%>
							<%@include file="xlkglydd/xlkglyddEntry.jsp"%>
							<%@include file="ylfxwlyddmlspcs/wlyddmlspcsEntry.jsp"%>
						</div>
					</div>
				</div>
				<!-- /Page Body -->
