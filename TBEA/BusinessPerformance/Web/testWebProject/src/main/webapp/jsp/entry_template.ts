...
//            if (this.mOpt.permission.entryPlan) {
//                switch (this.mOpt.entryType) {
//                    case Util.EntyType.QNJH:
//                        header = date.year + "年 计划数据录入";
//                        break;
//                    case Util.EntyType.BY20:
//                        header = date.year + "年" + date.month + "月 20日计划值录入";
//                        break;
//                    case Util.EntyType.BY28:
//                        header = date.year + "年" + date.month + "月 28日计划值录入";
//                        break;
//
//                }
...
//                    break;
//                case Util.EntyType.BY28:
//                    titles = this.createPredict(["指标类型", "本月28日预计值"]);
//                    break;  
//                case Util.EntyType.BYSJ:
//                    titles = ["指标名称", "本月实际"];
//                    break;
