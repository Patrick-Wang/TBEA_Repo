...
(function (jcycljg) {
    ...
    (function (jt) {
        ...
        var JtView = /** @class */ (function (_super) {
            __extends(JtView, _super);
            function JtView() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.mAjax = new Util.Ajax("/BusinessManagement/jcycljg/update.do?type=" + jcycljg.JcycljgType.JT, false);
                return _this;
            ...
            JtView.prototype.formateData = function (data) {
            ...
            JtView.prototype.adjustSize = function () {
                _super.prototype.adjustSize.call(this);
                this.updateChart();
            };
            JtView.prototype.createJqassist = function () {
                var parent = this.$(this.option().tb);
                parent.empty();
