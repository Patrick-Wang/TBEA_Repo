...
module plugin {
    export let xksczzzlwt : number = framework.basic.endpoint.lastId();
}
declare var echarts;
module nwbzlqk {
    export module xksczzzlwt {
        ...
        class ShowView extends ZlPluginView {
            ...
            private mAjax:Util.Ajax = new Util.Ajax("/BusinessManagement/xksczzzlwt/update.do", false);
            private mDt: string;
