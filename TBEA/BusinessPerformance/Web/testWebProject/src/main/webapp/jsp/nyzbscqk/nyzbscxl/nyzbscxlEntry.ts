...
module nyzbscqk {
    export module nyzbscxlEntry {
        ...
        class EntryView extends framework.basic.EntryPluginView {
            ...
            private mAjaxUpdate:Util.Ajax = new Util.Ajax("../nyzbscxl/entry/update.do", false);
            private mAjaxSave:Util.Ajax = new Util.Ajax("../nyzbscxl/entry/save.do", false);
            private mAjaxSubmit:Util.Ajax = new Util.Ajax("../nyzbscxl/entry/submit.do", false);
            private mDt:string;
