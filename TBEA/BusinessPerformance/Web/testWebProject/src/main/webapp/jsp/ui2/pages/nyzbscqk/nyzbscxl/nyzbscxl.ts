...
module plugin {
    ...
    export let wcwzbkqxl : number = framework.basic.endpoint.lastId();
    export let qtzbkqxl : number = framework.basic.endpoint.lastId();
}
...
module nyzbscqk {
    export module nyzbscxl {
        ...
        class ShowView extends framework.basic.ShowPluginView {
            ...
            private mAjax:Util.Ajax = new Util.Ajax("/BusinessManagement/nyzbscxl/update.do", false);
