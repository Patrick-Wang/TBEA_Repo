    ...
    (function (wgcpylnlspcsEntry) {
        ...
        var EntryView = /** @class */ (function (_super) {
            ...
            function EntryView() {
                ...
                _this.mAjaxUpdate = new Util.Ajax("../wgcpylnlspcs/entry/update.do", false);
                _this.mAjaxSave = new Util.Ajax("../wgcpylnlspcs/entry/save.do", false);
                _this.mAjaxSubmit = new Util.Ajax("../wgcpylnlspcs/entry/submit.do", false);
                return _this;
            }
