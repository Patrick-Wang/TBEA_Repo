...
<script src="../jsp/mkt_contract_analysis.js" type="text/javascript"></script>

<script type="text/javascript">
	var instance = mkt_contract_analysis.View.newInstance();
	(function() {
		$(document).ready(
				function() {
					...
					<tr>
						...
						<td><select id="analysisType" style="width: 190px"
							onchange="instance.onType_TypeSelected()">
								<option value="contract_industry">合同签约分析表(行业)</option>
								<option value="contract_company">合同签约分析表(单位)</option>
						</select></td>
