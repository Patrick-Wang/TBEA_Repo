...
module cpzlqk {
    export module pdacptjjgEntry {
        ...
        class EntryView extends ZlEntryPluginView {
            ...
            private mAjaxUpdate:Util.Ajax = new Util.Ajax("/BusinessManagement/pdacptjjg/entry/update.do", false);
            private mAjaxSave:Util.Ajax = new Util.Ajax("/BusinessManagement/pdacptjjg/entry/save.do", false);
            private mAjaxSubmit:Util.Ajax = new Util.Ajax("/BusinessManagement/pdacptjjg/entry/submit.do", false);
            private mDt:string;
