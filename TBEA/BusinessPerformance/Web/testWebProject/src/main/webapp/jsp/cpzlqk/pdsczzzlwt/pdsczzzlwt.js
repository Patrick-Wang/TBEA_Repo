...
var plugin;
(function (plugin) {
    plugin.pdsczzzlwt = framework.basic.endpoint.lastId();
})(plugin || (plugin = {}));
var cpzlqk;
(function (cpzlqk) {
    var pdsczzzlwt;
    (function (pdsczzzlwt) {
        ...
        var ShowView = (function (_super) {
            ...
            function ShowView() {
                ...
                this.mAjax = new Util.Ajax("../pdsczzzlwt/update.do", false);
            ...
            ShowView.prototype.pluginGetExportUrl = function (date, compType) {
                return "../pdsczzzlwt/export.do?" + Util.Ajax.toUrlParam({
                    date: date,
                    companyId: compType,
                    ydjd: this.mYdjdType
                });
    ...
    })(pdsczzzlwt = cpzlqk.pdsczzzlwt || (cpzlqk.pdsczzzlwt = {}));
})(cpzlqk || (cpzlqk = {}));
