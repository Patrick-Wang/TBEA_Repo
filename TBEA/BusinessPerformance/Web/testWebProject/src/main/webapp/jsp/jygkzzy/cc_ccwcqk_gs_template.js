...
(function (cc_ccwcqk_gs_template) {
    ...
    var View = (function () {
        ...
        View.prototype.updateEntry = function () {
            ...
            this.mCondition.get({ entryType: "20014" })
                .then(function (data) {
                _this.initInstance({
                    tableId: "table",
                    dateId: "date",
        ...
        View.prototype.exportExcel = function (fName) {
            ...
            $("#export")[0].action = "cc_ccwcqk_gs_export.do?" + Util.Ajax.toUrlParam({
    ...
    cc_ccwcqk_gs_template.View = View;
})(cc_ccwcqk_gs_template || (cc_ccwcqk_gs_template = {}));
