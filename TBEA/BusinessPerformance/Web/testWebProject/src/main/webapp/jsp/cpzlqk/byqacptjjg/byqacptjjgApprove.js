...
var cpzlqk;
(function (cpzlqk) {
    var byqacptjjgApprove;
    (function (byqacptjjgApprove) {
        ...
        var ApproveView = (function (_super) {
            ...
            function ApproveView() {
                ...
                this.mAjaxUpdate = new Util.Ajax("../byqacptjjg/approve/update.do", false);
                this.mAjaxApprove = new Util.Ajax("../byqacptjjg/approve/approve.do", false);
                this.mAjaxUnapprove = new Util.Ajax("../byqacptjjg/approve/unapprove.do", false);
            }
