...
<script src="${pageContext.request.contextPath}/jsp/ui2/pages/cwgbjyxxjl/cwgbjyxxjldef.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/jsp/ui2/pages/cwgbjyxxjl/cwgbjyxxjlEntry.js" type="text/javascript"></script>
				...
				<div class="page-body">
					<div class="row">
						<div class="col-lg-12 col-sm-12 col-xs-12">
							<%@include file="dyjyxxjl/dyjyxxjlEntry.jsp"%>
						</div>
					</div>
				</div>
				<!-- /Page Body -->
