...
module cpzlqk {
    export module pdcpycssbhgwtmxEntry {
        ...
        class EntryView extends ZlEntryPluginView {
            ...
            private mAjaxUpdate:Util.Ajax = new Util.Ajax("../pdcpycssbhgwtmx/entry/update.do", false);
            private mAjaxSave:Util.Ajax = new Util.Ajax("../pdcpycssbhgwtmx/entry/save.do", false);
            private mAjaxSubmit:Util.Ajax = new Util.Ajax("../pdcpycssbhgwtmx/entry/submit.do", false);
            private mDt:string;
