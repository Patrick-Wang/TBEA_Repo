...
var plugin;
(function (plugin) {
    plugin.xkysazzlwt = framework.basic.endpoint.lastId();
})(plugin || (plugin = {}));
var nwbzlqk;
(function (nwbzlqk) {
    var xkysazzlwt;
    (function (xkysazzlwt) {
        ...
        var ShowView = (function (_super) {
            ...
            function ShowView() {
                ...
                _this.mAjax = new Util.Ajax("/BusinessManagement/xkysazzlwt/update.do", false);
                return _this;
    ...
    })(xkysazzlwt = nwbzlqk.xkysazzlwt || (nwbzlqk.xkysazzlwt = {}));
})(nwbzlqk || (nwbzlqk = {}));
