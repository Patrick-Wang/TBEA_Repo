...
module pluginEntry {
    export let xkacptjjg : number = framework.basic.endpoint.lastId();
}

module cpzlqk {
    export module xkacptjjgEntry {
        ...
        class EntryView extends ZlEntryPluginView {
            ...
            private mAjaxUpdate:Util.Ajax = new Util.Ajax("/BusinessManagement/xkacptjjg/entry/update.do", false);
            private mAjaxSave:Util.Ajax = new Util.Ajax("/BusinessManagement/xkacptjjg/entry/save.do", false);
            private mAjaxSubmit:Util.Ajax = new Util.Ajax("/BusinessManagement/xkacptjjg/entry/submit.do", false);
            private mDt:string;
            ...
            protected isSupported(compType:Util.CompanyType):boolean {
                if (compType == Util.CompanyType.XKGS){
                    return true;
                }
                return false;
            }
