...
var plugin;
(function (plugin) {
    plugin.xlwbzlwttjqk = framework.basic.endpoint.lastId();
})(plugin || (plugin = {}));
var nwbzlqk;
(function (nwbzlqk) {
    var xlwbzlwttjqk;
    (function (xlwbzlwttjqk) {
        ...
        var ShowView = /** @class */ (function (_super) {
            ...
            function ShowView() {
                ...
                _this.mAjax = new Util.Ajax("/BusinessManagement/xlwbzlwttjqk/update.do", false);
                return _this;
    ...
    })(xlwbzlwttjqk = nwbzlqk.xlwbzlwttjqk || (nwbzlqk.xlwbzlwttjqk = {}));
})(nwbzlqk || (nwbzlqk = {}));
