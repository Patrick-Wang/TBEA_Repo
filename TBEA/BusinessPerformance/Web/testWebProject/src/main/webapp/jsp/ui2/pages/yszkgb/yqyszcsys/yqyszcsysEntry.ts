...
declare var echarts;
declare var $;
module yszkgb { export module yqyszcsys {
    ...
    class SimplePluginEntryView extends BaseEntryPluginView {
        ...
        private mAjaxUpdate:Util.Ajax = new Util.Ajax("/BusinessManagement/yszkgb//yqyszcsys/entry/update.do", false);
        private mAjaxSave:Util.Ajax = new Util.Ajax("/BusinessManagement/yszkgb/yqyszcsys/entry/save.do", false);
        private mAjaxSubmit:Util.Ajax = new Util.Ajax("/BusinessManagement/yszkgb/yqyszcsys/entry/submit.do", false);
        private mDt:string;
        private mTableAssist:JQTable.JQGridAssistant;
        private mIsReadOnly:boolean;

        private static ins : SimplePluginEntryView = new SimplePluginEntryView("yqyszcsys");
