...
module plugin {
    export let pdwbzlwttjqk : number = framework.basic.endpoint.lastId();
}
declare var echarts;
module nwbzlqk {
    export module pdwbzlwttjqk {
        ...
        class ShowView extends ZlPluginView {
            ...
            private mAjax:Util.Ajax = new Util.Ajax("/BusinessManagement/pdwbzlwttjqk/update.do", false);
            ...
            pluginGetExportUrl(date:string, compType:Util.CompanyType):string {
                return "/BusinessManagement/pdwbzlwttjqk/export.do?" + Util.Ajax.toUrlParam({
                        date: date,
                        companyId:compType,
                        ydjd:this.mYdjdType
                 });
