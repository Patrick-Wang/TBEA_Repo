...
module plugin {
    export let xlsczzzlwtxxxx : number = framework.basic.endpoint.lastId();
}
declare var echarts;
module nwbzlqk {
    export module xlsczzzlwtxxxx {
        ...
        class JQGridAssistantFactory {
            public static createZtTable(gridName:string, ydjd:YDJDType):JQTable.JQGridAssistant {
                return new JQTable.JQGridAssistant([
                    ...
                    Node.create({name : ydjd == YDJDType.YD ? "当月" : "季度"})
                        .append(Node.create({name : ydjd == YDJDType.YD ? "月度" : "季度"}))
                        .append(Node.create({name : "年度累计"})),
                    Node.create({name : ydjd == YDJDType.YD ? "去年同期" : "去年同期"})
                        .append(Node.create({name : ydjd == YDJDType.YD ? "月度" : "季度"}))
                        .append(Node.create({name : "年度累计"}))
                ], gridName);
            }
