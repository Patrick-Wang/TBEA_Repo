...
<script src="../jsp/jygkzzy/fx_jkcb_xsjb_template.js" type="text/javascript"></script>
...
<script type="text/javascript">
	var view = fx_jkcb_xsjb_template.View.getInstance();
    (function () {
		$(document).ready(function () {
          	view.initBglxViewSelect({bglxId : "div_bglx", curbglx : "20011"});
            $("#bglx").val("20011");
            view.updateEntry(); 
			/*view.initInstance({
				tableId : "table",
