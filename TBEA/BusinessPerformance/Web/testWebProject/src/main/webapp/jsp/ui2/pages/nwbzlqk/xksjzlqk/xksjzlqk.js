...
var plugin;
(function (plugin) {
    plugin.xksjzlqk = framework.basic.endpoint.lastId();
})(plugin || (plugin = {}));
var nwbzlqk;
(function (nwbzlqk) {
    var xksjzlqk;
    (function (xksjzlqk) {
        ...
        var ShowView = (function (_super) {
            ...
            function ShowView() {
                ...
                _this.mAjax = new Util.Ajax("/BusinessManagement/xksjzlqk/update.do", false);
                return _this;
    ...
    })(xksjzlqk = nwbzlqk.xksjzlqk || (nwbzlqk.xksjzlqk = {}));
})(nwbzlqk || (nwbzlqk = {}));
