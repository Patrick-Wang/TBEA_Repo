...
module pluginEntry {
    export let yylkvyscpycssbhg : number = framework.basic.endpoint.lastId();
}

module cpzlqkyd {
    export module yylkvyscpycssbhgEntry {
        ...
        class EntryView extends framework.basic.EntryPluginView {
            ...
            private mAjaxUpdate:Util.Ajax = new Util.Ajax("../yylkvyscpycssbhg/entry/update.do", false);
            private mAjaxSave:Util.Ajax = new Util.Ajax("../yylkvyscpycssbhg/entry/save.do", false);
            private mAjaxSubmit:Util.Ajax = new Util.Ajax("../yylkvyscpycssbhg/entry/submit.do", false);
            private mDt:string;
