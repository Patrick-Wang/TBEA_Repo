...
<script src="${pageContext.request.contextPath}/jsp/nyzbscqk/nyzbscqkdef.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/jsp/nyzbscqk/nyzbscqkEntry.js" type="text/javascript"></script>
<title>能源市场周边情况</title>
