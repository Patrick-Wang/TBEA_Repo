...
<script src="${pageContext.request.contextPath}/jsp/ui2/pages/nyzbscqk/nyzbscqkdef.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/jsp/ui2/pages/nyzbscqk/nyzbscqkEntry.js" type="text/javascript"></script>
			...
			<div class="page-content">
				...
				<div class="page-header position-relative">
					<div class="header-title">
						...
						<div id="submit" class="btn btn-default pull-right" onclick="framework.router.to(framework.basic.endpoint.FRAME_ID).send(framework.basic.FrameEvent.FE_SUBMIT)">
							提交 <i class="fa fa-upload"></i>
						</div>
						<div id="save" class="btn btn-default pull-right" onclick="framework.router.to(framework.basic.endpoint.FRAME_ID).send(framework.basic.FrameEvent.FE_SAVE)" >
				...
				<div class="page-body">
					<div class="row">
						<div class="col-lg-12 col-sm-12 col-xs-12">
							<%@include file="nyzbscjg/nyzbscjgEntry.jsp"%>
							<%@include file="nyzbscxl/nyzbscxlEntry.jsp"%>
						</div>
					</div>
				</div>
				<!-- /Page Body -->
