...
module plugin {
    export let xknbzlwtfl : number = framework.basic.endpoint.lastId();
}
declare var echarts;
module nwbzlqk {
    export module xknbzlwtfl {
        ...
        class ShowView extends ZlPluginView {
            ...
            private mAjax:Util.Ajax = new Util.Ajax("/BusinessManagement/xknbzlwtfl/update.do", false);
            private mDt: string;
