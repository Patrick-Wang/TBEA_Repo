...
module cwcpdlml {
    export module cpdlmlEntry {
        ...
        class EntryView extends framework.basic.EntryPluginView {
            ...
            private mAjaxUpdate:Util.Ajax = new Util.Ajax("../cpdlml/entry/update.do", false);
            private mAjaxSave:Util.Ajax = new Util.Ajax("../cpdlml/entry/save.do", false);
            private mAjaxSubmit:Util.Ajax = new Util.Ajax("../cpdlml/entry/submit.do", false);
            private mDt:string;
