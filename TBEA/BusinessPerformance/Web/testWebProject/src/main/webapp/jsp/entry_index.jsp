...
<script src="../jsp/entry_index.js" type="text/javascript"></script>

<script type="text/javascript">
	var view = entryIndex.View.getInstance();
	(function() {
...
<body>
	...
	<Table style="margin-left: 80px">
		<c:if test="${entryPlan}">
			<tr>
				<td><a href="zb.do?entryType=0">录入年计划数据</a></td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				<td><a href="zb.do?entryType=1">录入20日计划值</a></td>
			</tr>
			<tr>
				<td>
					<div class="devide"></div>
			...
			<tr>
				<td><a href="zb.do?entryType=2">录入28日计划值</a></td>
			</tr>
			<tr>
				<td>
					<div class="devide"></div>
		...
		<c:if test="${entryPredict}">
			<tr>
				<td><a href="zb.do?entryType=3">录入20日预计值</a></td>
			</tr>
			<tr>
				<td>
					<div class="devide"></div>
			...
			<tr>
				<td><a href="zb.do?entryType=4">录入28日预计值</a></td>
			</tr>
			<tr>
				<td>
					<div class="devide"></div>
			...
			<tr>
				<td><a href="zb.do?entryType=5">录入月实际数据</a></td>
			</tr>
		</c:if>
	</Table>
</body>
