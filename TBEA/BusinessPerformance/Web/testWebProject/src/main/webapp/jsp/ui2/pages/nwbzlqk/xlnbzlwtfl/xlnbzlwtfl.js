...
var plugin;
(function (plugin) {
    plugin.xlnbzlwtfl = framework.basic.endpoint.lastId();
})(plugin || (plugin = {}));
var nwbzlqk;
(function (nwbzlqk) {
    var xlnbzlwtfl;
    (function (xlnbzlwtfl) {
        ...
        var ShowView = /** @class */ (function (_super) {
            ...
            function ShowView() {
                ...
                _this.mAjax = new Util.Ajax("/BusinessManagement/xlnbzlwtfl/update.do", false);
                return _this;
            }
            ShowView.prototype.getId = function () {
                return plugin.xlnbzlwtfl;
            };
            ...
            ShowView.prototype.pluginGetExportUrl = function (date, compType) {
                return "/BusinessManagement/xlnbzlwtfl/export.do?" + Util.Ajax.toUrlParam({
                    date: date,
                    companyId: compType,
                    ydjd: this.mYdjdType
                });
    ...
    })(xlnbzlwtfl = nwbzlqk.xlnbzlwtfl || (nwbzlqk.xlnbzlwtfl = {}));
})(nwbzlqk || (nwbzlqk = {}));
