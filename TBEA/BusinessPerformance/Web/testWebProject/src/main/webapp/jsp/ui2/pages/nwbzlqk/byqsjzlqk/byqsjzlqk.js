...
var plugin;
(function (plugin) {
    plugin.byqsjzlqk = framework.basic.endpoint.lastId();
})(plugin || (plugin = {}));
var nwbzlqk;
(function (nwbzlqk) {
    var byqsjzlqk;
    (function (byqsjzlqk) {
        ...
        var ShowView = /** @class */ (function (_super) {
            ...
            function ShowView() {
                ...
                _this.mAjax = new Util.Ajax("/BusinessManagement/byqsjzlqk/update.do", false);
                return _this;
            ...
            ShowView.prototype.pluginGetExportUrl = function (date, compType) {
                return "/BusinessManagement/byqsjzlqk/export.do?" + Util.Ajax.toUrlParam({
                    date: date,
                    companyId: compType,
                    ydjd: this.mYdjdType
                });
    ...
    })(byqsjzlqk = nwbzlqk.byqsjzlqk || (nwbzlqk.byqsjzlqk = {}));
})(nwbzlqk || (nwbzlqk = {}));
