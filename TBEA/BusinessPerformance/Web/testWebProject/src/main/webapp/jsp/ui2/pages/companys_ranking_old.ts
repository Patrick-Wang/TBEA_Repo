...
enum RANKINGTYPE11{GSMC,NDJH, NDLJWC,JHWCL,YEARRANKING, YDJH, YDWC,YDWCL,MONTHRANKING};
//利润指标年度累计完成同比增长情况排名
enum RANKINGTYPE21{GSMC,NDLJ,QNTQLJ,NDTBZZ,YEARRANKING,DYWC,QNTQ,YDTBZZ,MONTHRANKING};
//人均利润，人均收入
enum RANKINGTYPE31{GSMC,NDLJ,YEARRANKING,DYWC,MONTHRANKING};
//应收账款占收入排名
enum RANKINGTYPE41{GSMC,BYSR,BYYSZK,YSZKZSRBZ,MONTHRANKING};
//应收账款加保理
enum RANKINGTYPE51{GSMC,BYSR,BYYSZK,BYBLYE,YSZKZSRBZ,MONTHRANKING};
//存货占比
enum RANKINGTYPE61{GSMC,BYSR,BYCH,CHZSRBZ,MONTHRANKING};
//应收账款加存货占比
enum RANKINGTYPE71{GSMC,BYSR,BYYSZK,BYCH,YSZKCHZSRBZ,MONTHRANKING};
module companys_ranking1 {
