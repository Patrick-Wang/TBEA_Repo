...
<body>
	...
	window.data = {
			qsfx:{
				jh:[rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand()],
				sj:[rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand(),rand()]
			},
			hydb : {
				rqs:["2012年","2013年","2014年","2015年","2016年"],
				byqhyjzs:[rand(),rand(),rand(),rand(),rand()],
				sblrs:[rand(),rand(),rand(),rand(),rand()],
				hblrs:[rand(),rand(),rand(),rand(),rand()],
				xblrs:[rand(),rand(),rand(),rand(),rand()],
				byqlrs:[rand(),rand(),rand(),rand(),rand()],
				xlhyjzs:[rand(),rand(),rand(),rand(),rand()],
				lllrs:[rand(),rand(),rand(),rand(),rand()],
				xllrs:[rand(),rand(),rand(),rand(),rand()],
				dllrs:[rand(),rand(),rand(),rand(),rand()],
				xlcylrs:[rand(),rand(),rand(),rand(),rand()],
			},
			lrfx:{
				zbmcs:['指标A', '指标B','指标C','指标D','指标E'],
				zbfx:[rand(),rand(),rand(),rand(),rand()]
			}
	};
    ...
    function switchHy(){
    	if ('byq' == $(".fa-refresh").attr("data-value")){
    		var legend = ["行业A均值", "公司A1", "公司A2", "公司A3", "公司A4"];
    		...
    		var legend = ["行业B均值", "公司B1", "公司B2", "公司B3", "公司B4"];
