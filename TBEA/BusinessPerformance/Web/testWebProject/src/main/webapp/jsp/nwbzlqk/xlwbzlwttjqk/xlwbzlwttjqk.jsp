<%@ page language="java" contentType="text/html; charset=utf-8"
	pageEncoding="utf-8"%>
<Table id="xlwbzlwttjqk" align="center" style="display: none;">
    <tr id="tbarea">
        <td>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/jsp/nwbzlqk/xlwbzlwttjqk/xlwbzlwttjqk.js"></script>
