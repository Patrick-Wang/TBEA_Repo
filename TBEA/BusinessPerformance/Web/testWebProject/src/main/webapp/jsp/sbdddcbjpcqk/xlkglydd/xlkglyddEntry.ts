...
module sbdddcbjpcqk {
    export module xlkglyddEntry {
        ...
        class JQGridAssistantFactory {
            public static createTable(gridName:string, type:KglyddType, readOnly:boolean, cplb:string[]):JQTable.JQGridAssistant {
