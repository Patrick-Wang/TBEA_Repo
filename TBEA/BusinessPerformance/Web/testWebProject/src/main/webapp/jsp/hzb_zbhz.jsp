    ...
    <script type="text/javascript">
        (function () {
            $(document).ready(function () {
                hzb_zbhz.View.newInstance().init("table", ${month}, ${year});
            });
        })();
    </script>
    <meta charset="UTF-8">
...
<body style="width:1400px">
  ...
  <script type="text/javascript">
		function onYearChange(year){
			...
			;
			hzb_zbhz.View.newInstance().onYearSelected(year);
			hzb_zbhz.View.newInstance().onMonthSelected($("#month_" + year + " option:selected").val());
		}
	</script>
	<table>
		<tr>
			...
			<td>
				<select id= "month_${year}"
					onchange="hzb_zbhz.View.newInstance().onMonthSelected(this.value)" style="width: 125px;">
				...
				<select id= "month_${year - 1}"
					onchange="hzb_zbhz.View.newInstance().onMonthSelected(this.value)" style="width: 125px;display:none">
			...
			<td>
				<input type="button" value="更新" onclick="hzb_zbhz.View.newInstance().updateUI()"></input>
			</td>
		</tr>
	</table>
