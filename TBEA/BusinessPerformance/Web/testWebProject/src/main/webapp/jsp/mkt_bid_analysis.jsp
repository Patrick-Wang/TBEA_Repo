...
<script src="../jsp/mkt_bid_analysis.js" type="text/javascript"></script>

<script type="text/javascript">
	var instance = mkt_bid_analysis.View.newInstance();
	(function() {
		$(document).ready(
				function() {
