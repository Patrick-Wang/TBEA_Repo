...
/// <reference path="../cwgbdef.ts"/>
declare var $:any;


module pluginEntry {
    export let cpdlmlb : number = framework.basic.endpoint.lastId();
}

module cwgb {
    export module cpdlmlbEntry {
        ...
        class EntryView extends framework.basic.EntryPluginView {
            ...
            private mAjaxUpdate:Util.Ajax = new Util.Ajax("../cpdlmlb/entry/update.do", false);
            private mAjaxSave:Util.Ajax = new Util.Ajax("../cpdlmlb/entry/save.do", false);
            private mAjaxSubmit:Util.Ajax = new Util.Ajax("../cpdlmlb/entry/submit.do", false);
            private mDt:string;
            private mTableAssist:JQTable.JQGridAssistant;
            private mCompType:Util.CompanyType;
            getId():number {
                return pluginEntry.cpdlmlb;
            }
