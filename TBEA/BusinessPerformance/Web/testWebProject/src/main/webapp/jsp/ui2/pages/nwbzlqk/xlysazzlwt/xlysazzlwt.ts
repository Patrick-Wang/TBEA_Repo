...
module plugin {
    export let xlysazzlwt : number = framework.basic.endpoint.lastId();
}
declare var echarts;
module nwbzlqk {
    export module xlysazzlwt {
        ...
        class ShowView extends ZlPluginView {
            ...
            private mAjax:Util.Ajax = new Util.Ajax("/BusinessManagement/xlysazzlwt/update.do", false);
            private mDt: string;
