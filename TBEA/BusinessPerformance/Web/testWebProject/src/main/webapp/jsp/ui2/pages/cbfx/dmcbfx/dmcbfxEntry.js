    ...
    (function (dmcbfxEntry) {
        ...
        var EntryView = (function (_super) {
            ...
            function EntryView() {
                ...
                _this.mAjaxUpdate = new Util.Ajax("/BusinessManagement/dmcbfx/entry/update.do", false);
                _this.mAjaxSave = new Util.Ajax("/BusinessManagement/dmcbfx/entry/save.do", false);
                _this.mAjaxSubmit = new Util.Ajax("/BusinessManagement/dmcbfx/entry/submit.do", false);
                return _this;
            }
