...
(function (nwbzlqk) {
    ...
    (function (pdsczzzlwt) {
        ...
        var ShowView = /** @class */ (function (_super) {
            ...
            function ShowView() {
                ...
                _this.mAjax = new Util.Ajax("/BusinessManagement/pdsczzzlwt/update.do", false);
                return _this;
            ...
            ShowView.prototype.pluginGetExportUrl = function (date, compType) {
                return "/BusinessManagement/pdsczzzlwt/export.do?" + Util.Ajax.toUrlParam({
                    date: date,
                    companyId: compType,
                    ydjd: this.mYdjdType
                });
    ...
    })(pdsczzzlwt = nwbzlqk.pdsczzzlwt || (nwbzlqk.pdsczzzlwt = {}));
})(nwbzlqk || (nwbzlqk = {}));
