...
module cpzlqk {
    export module byqcpycssbhgwtmxEntry {
        ...
        class EntryView extends ZlEntryPluginView {
            ...
            private mAjaxUpdate:Util.Ajax = new Util.Ajax("/BusinessManagement/byqcpycssbhgwtmx/entry/update.do", false);
            private mAjaxSave:Util.Ajax = new Util.Ajax("/BusinessManagement/byqcpycssbhgwtmx/entry/save.do", false);
            private mAjaxSubmit:Util.Ajax = new Util.Ajax("/BusinessManagement/byqcpycssbhgwtmx/entry/submit.do", false);
            private mDt:string;
