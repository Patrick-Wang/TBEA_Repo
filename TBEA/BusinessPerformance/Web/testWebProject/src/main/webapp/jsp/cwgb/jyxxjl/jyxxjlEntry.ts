...
module pluginEntry {
    export let jyxxjl : number = framework.basic.endpoint.lastId();
}

module cwgb {
    export module jyxxjlEntry {
        ...
        class EntryView extends framework.basic.EntryPluginView {
            ...
            private mAjaxUpdate:Util.Ajax = new Util.Ajax("../jyxxjl/entry/update.do", false);
            private mAjaxSave:Util.Ajax = new Util.Ajax("../jyxxjl/entry/save.do", false);
            private mAjaxSubmit:Util.Ajax = new Util.Ajax("../jyxxjl/entry/submit.do", false);
            private mDt:string;
            private mTableAssist:JQTable.JQGridAssistant;
            private mCompType:Util.CompanyType;
            getId():number {
                return pluginEntry.jyxxjl;
            }
