...
module basicReport {
    export module basicEntry {
        ...
        class EntryView extends framework.basic.EntryPluginView {
            ...
            private mAjaxUpdate:Util.Ajax = new Util.Ajax("../basic/entry/update.do", false);
            private mAjaxSave:Util.Ajax = new Util.Ajax("../basic/entry/save.do", false);
            private mAjaxSubmit:Util.Ajax = new Util.Ajax("../basic/entry/submit.do", false);
            private mDt:string;
