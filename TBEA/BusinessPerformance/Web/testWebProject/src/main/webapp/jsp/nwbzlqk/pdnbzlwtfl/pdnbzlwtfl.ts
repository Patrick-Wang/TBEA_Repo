...
module plugin {
    export let pdnbzlwtfl : number = framework.basic.endpoint.lastId();
}
declare var echarts;
module nwbzlqk {
    export module pdnbzlwtfl {
        ...
        class ShowView extends ZlPluginView {
            ...
            private mAjax:Util.Ajax = new Util.Ajax("../pdnbzlwtfl/update.do", false);
            ...
            pluginGetExportUrl(date:string, compType:Util.CompanyType):string {
                return "../pdnbzlwtfl/export.do?" + Util.Ajax.toUrlParam({
                        date: date,
                        companyId:compType,
                        ydjd:this.mYdjdType
                 });
