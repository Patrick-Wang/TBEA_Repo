...
module wlyddqk {
    export module byqkglyddEntry {
        ...
        class ByqkglyddEntryView extends wlyddqk.BaseEntryPluginView {
            ...
            private mAjaxUpdate:Util.Ajax = new Util.Ajax("/BusinessManagement/sbdddcbjpcqk/byqkglydd/entry/update.do", false);
            private mAjaxSave:Util.Ajax = new Util.Ajax("/BusinessManagement/sbdddcbjpcqk/byqkglydd/entry/save.do", false);
            private mAjaxSubmit:Util.Ajax = new Util.Ajax("/BusinessManagement/sbdddcbjpcqk/byqkglydd/entry/submit.do", false);
            private mDt:string;
