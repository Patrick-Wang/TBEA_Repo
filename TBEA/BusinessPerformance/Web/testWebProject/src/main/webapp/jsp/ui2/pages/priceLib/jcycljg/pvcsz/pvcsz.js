...
(function (jcycljg) {
    ...
    (function (pvcsz) {
        ...
        var PVCSzView = /** @class */ (function (_super) {
            __extends(PVCSzView, _super);
            function PVCSzView() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.mAjax = new Util.Ajax("/BusinessManagement/jcycljg/update.do?type=" + jcycljg.JcycljgType.PVCSZ, false);
                return _this;
            ...
            PVCSzView.prototype.createJqassist = function () {
                var parent = this.$(this.option().tb);
                parent.empty();
