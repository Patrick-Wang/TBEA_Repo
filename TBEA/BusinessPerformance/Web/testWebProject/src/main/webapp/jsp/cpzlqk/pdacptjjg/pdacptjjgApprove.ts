...
module cpzlqk {
    export module pdacptjjgApprove {
        ...
        class ApproveView extends ZlApprovePluginView {
            ...
            private mAjaxUpdate:Util.Ajax = new Util.Ajax("../pdacptjjg/approve/update.do", false);
            private mAjaxApprove:Util.Ajax = new Util.Ajax("../pdacptjjg/approve/approve.do", false);
            private mAjaxUnapprove:Util.Ajax = new Util.Ajax("../pdacptjjg/approve/unapprove.do", false);
            private mDt:string;
