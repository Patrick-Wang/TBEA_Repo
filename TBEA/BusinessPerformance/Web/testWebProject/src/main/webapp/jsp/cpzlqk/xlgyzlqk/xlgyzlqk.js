...
var plugin;
(function (plugin) {
    plugin.xlgyzlqk = framework.basic.endpoint.lastId();
})(plugin || (plugin = {}));
var cpzlqk;
(function (cpzlqk) {
    var xlgyzlqk;
    (function (xlgyzlqk) {
        ...
        var JQGridAssistantFactory = (function () {
            ...
            JQGridAssistantFactory.createZtTable = function (gridName, ydjd) {
                return new JQTable.JQGridAssistant([
                    ...
                    Node.create({ name: ydjd == cpzlqk.YDJDType.YD ? "当月" : "当期" })
        ...
        var ShowView = (function (_super) {
            ...
            function ShowView() {
                ...
                this.mAjax = new Util.Ajax("../xlgyzlqk/update.do", false);
            ...
            ShowView.prototype.pluginGetExportUrl = function (date, compType) {
                return "../xlgyzlqk/export.do?" + Util.Ajax.toUrlParam({
                    date: date,
                    companyId: compType,
                    ydjd: this.mYdjdType
                });
            ...
            ShowView.prototype.init = function (opt) {
                framework.router
                    .fromEp(this)
                    .to(framework.basic.endpoint.FRAME_ID)
                    .send(framework.basic.FrameEvent.FE_REGISTER, "设计工艺问题情况");
            };
    ...
    })(xlgyzlqk = cpzlqk.xlgyzlqk || (cpzlqk.xlgyzlqk = {}));
})(cpzlqk || (cpzlqk = {}));
