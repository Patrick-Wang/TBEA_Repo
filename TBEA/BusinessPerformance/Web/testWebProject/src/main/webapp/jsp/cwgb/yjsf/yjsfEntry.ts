...
module cwgb {
    export module yjsfEntry {
        ...
        class EntryView extends framework.basic.EntryPluginView {
            ...
            private mAjaxUpdate:Util.Ajax = new Util.Ajax("../yjsf/entry/update.do", false);
            private mAjaxSave:Util.Ajax = new Util.Ajax("../yjsf/entry/save.do", false);
            private mAjaxSubmit:Util.Ajax = new Util.Ajax("../yjsf/entry/submit.do", false);
            private mDt:string;
