					...
					<div class="header-title">
						<div id="headerHost" class="pull-left">
							...
							<c:if test="${pageType == 2}">
								<%-- 2 录入页面--%>
								<div id="saveComment" class="btn btn-default pull-right"
