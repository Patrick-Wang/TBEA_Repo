...
<head>
	...
	<script src="../jsp/jygkzzy/fx_jkcb_jsjb_byq_template.js" type="text/javascript"></script>	

    <script type="text/javascript">
       	var view = fx_jkcb_jsjb_byq.View.getInstance();
        (function () {
    ...
    <title>${year}年${month}月技术降本</title>
