...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/webuploader/webuploader.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/jsp/util.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/jsp/unitedSelector.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/jsp/companySelector.js"></script>
...
<body>
	...
	<table id="documentTypeSelector" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td>
				<div id="compid" style="float:right"></div>
			</td>
		</tr>
		<!-- <tr>
			<td>
