...
module pluginEntry {
    export let pbcpycssbhg : number = framework.basic.endpoint.lastId();
}

module cpzlqkyd {
    export module pbcpycssbhgEntry {
        ...
        class EntryView extends framework.basic.EntryPluginView {
            ...
            private mAjaxUpdate:Util.Ajax = new Util.Ajax("../pbcpycssbhg/entry/update.do", false);
            private mAjaxSave:Util.Ajax = new Util.Ajax("../pbcpycssbhg/entry/save.do", false);
            private mAjaxSubmit:Util.Ajax = new Util.Ajax("../pbcpycssbhg/entry/submit.do", false);
            private mDt:string;
