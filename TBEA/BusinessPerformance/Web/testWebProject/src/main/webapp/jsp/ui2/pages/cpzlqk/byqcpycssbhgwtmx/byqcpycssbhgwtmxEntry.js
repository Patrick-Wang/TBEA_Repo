    ...
    (function (byqcpycssbhgwtmxEntry) {
        ...
        var EntryView = (function (_super) {
            ...
            function EntryView() {
                ...
                this.mAjaxUpdate = new Util.Ajax("/BusinessManagement/byqcpycssbhgwtmx/entry/update.do", false);
                this.mAjaxSave = new Util.Ajax("/BusinessManagement/byqcpycssbhgwtmx/entry/save.do", false);
                this.mAjaxSubmit = new Util.Ajax("/BusinessManagement/byqcpycssbhgwtmx/entry/submit.do", false);
            }
