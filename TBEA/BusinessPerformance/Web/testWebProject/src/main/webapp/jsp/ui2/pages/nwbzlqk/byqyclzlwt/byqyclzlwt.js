...
(function (nwbzlqk) {
    ...
    (function (byqyclzlwt) {
        ...
        var ShowView = (function (_super) {
            ...
            function ShowView() {
                ...
                _this.mAjax = new Util.Ajax("/BusinessManagement/byqyclzlwt/update.do", false);
                return _this;
            ...
            ShowView.prototype.pluginGetExportUrl = function (date, compType) {
                return "/BusinessManagement/byqyclzlwt/export.do?" + Util.Ajax.toUrlParam({
                    date: date,
                    companyId: compType,
                    ydjd: this.mYdjdType
                });
    ...
    })(byqyclzlwt = nwbzlqk.byqyclzlwt || (nwbzlqk.byqyclzlwt = {}));
})(nwbzlqk || (nwbzlqk = {}));
