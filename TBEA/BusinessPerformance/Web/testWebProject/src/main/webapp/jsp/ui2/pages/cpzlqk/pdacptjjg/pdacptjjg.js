    ...
    (function (pdacptjjg) {
        ...
        var ShowView = /** @class */ (function (_super) {
            ...
            function ShowView() {
                ...
                _this.mAjax = new Util.Ajax("/BusinessManagement/pdacptjjg/update.do", false);
                ...
                _this.mAjaxStatus = new Util.Ajax("/BusinessManagement/pdacptjjg/updateStatus.do", false);
                return _this;
            }
            ...
            ShowView.prototype.pluginGetExportUrl = function (date, compType) {
                return "/BusinessManagement/pdacptjjg/export.do?" + Util.Ajax.toUrlParam({
                    date: date,
                    companyId: compType,
                    ydjd: this.mYdjdType
                });
