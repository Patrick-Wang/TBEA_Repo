...
<head>
    ...
    <script src="../jsp/gdw_zbhz.js" type="text/javascript"></script>

    <script type="text/javascript">
        (function () {
            $(document).ready(function () {
                gdw_zbhz.View.newInstance().init("table", ${month}, ${year});
            });
        })();
    </script>
    <meta charset="UTF-8">
...
<body style="width:1400px">
	...
	<script type="text/javascript">
		function onYearChange(year){
			...
			;
			gdw_zbhz.View.newInstance().onYearSelected(year);
			gdw_zbhz.View.newInstance().onMonthSelected($("#month_" + year + " option:selected").val());
		}
	</script>
	<table>
		<tr>
			...
			<td>
				<select id= "month_${year}"
					onchange="gdw_zbhz.View.newInstance().onMonthSelected(this.value)" style="width: 125px;">
				...
				<select id= "month_${year - 1}"
					onchange="gdw_zbhz.View.newInstance().onMonthSelected(this.value)" style="width: 125px;display:none">
			...
			<td>
				<input type="button" value="更新" onclick="gdw_zbhz.View.newInstance().updateUI()"></input>
			</td>
		</tr>
	</table>
