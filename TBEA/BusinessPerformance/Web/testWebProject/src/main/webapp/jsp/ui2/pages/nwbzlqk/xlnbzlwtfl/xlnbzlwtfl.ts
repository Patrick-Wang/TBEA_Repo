...
module plugin {
    export let xlnbzlwtfl : number = framework.basic.endpoint.lastId();
}
declare var echarts;
module nwbzlqk {
    export module xlnbzlwtfl {
        ...
        class ShowView extends ZlPluginView {
            ...
            private mAjax:Util.Ajax = new Util.Ajax("/BusinessManagement/xlnbzlwtfl/update.do", false);
            private mDt: string;
