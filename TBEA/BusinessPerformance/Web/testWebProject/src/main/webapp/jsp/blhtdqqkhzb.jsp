...
<script src="../jsp/blhtdqqkhzb.js" type="text/javascript"></script>

<script type="text/javascript">
            (function () {
                $(document).ready(function () {
                    blhtdqqkhzb.View.newInstance().init("chart", "table", [
                        ${month},//month
                        ${year},//year
                        eval(${blyeqs}),//tabledata
                        eval(${blhtdqqk})//chartdata
                    ]);
                });
            })();
    </script>
