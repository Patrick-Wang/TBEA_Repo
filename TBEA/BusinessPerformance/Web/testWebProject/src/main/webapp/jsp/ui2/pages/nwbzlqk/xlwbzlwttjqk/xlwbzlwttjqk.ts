...
module plugin {
    export let xlwbzlwttjqk : number = framework.basic.endpoint.lastId();
}
declare var echarts;
module nwbzlqk {
    export module xlwbzlwttjqk {
        ...
        class ShowView extends ZlPluginView {
            ...
            private mAjax:Util.Ajax = new Util.Ajax("/BusinessManagement/xlwbzlwttjqk/update.do", false);
