...
(function (jcycljg) {
    ...
    (function (lwg) {
        ...
        var LwgView = /** @class */ (function (_super) {
            __extends(LwgView, _super);
            function LwgView() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.mAjax = new Util.Ajax("/BusinessManagement/jcycljg/update.do?type=" + jcycljg.JcycljgType.LWG, false);
                return _this;
            ...
            LwgView.prototype.adjustSize = function () {
                _super.prototype.adjustSize.call(this);
                this.update1214Chart();
                this.update1625Chart();
            };
            LwgView.prototype.createJqassist = function () {
                var parent = this.$(this.option().tb);
                parent.empty();
