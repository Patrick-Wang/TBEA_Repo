	...
	<script>
		...
		if (date && date.year){
            ...
            getExportDate = function () {
                var ret = {};
                var curDate =  $("#grid-export-date").getDate();
                ret = {
                    year: curDate.getFullYear(),
                    month: curDate.getMonth() + 1,
                    day: curDate.getDate()
		...
		var ajaxGet = new Util.Ajax('${exportUrl}.do');

		$("#exportBtn").on('click', function(){
            var dt = getExportDate();
            var sdt = dt.year + "-" + dt.month + "-" + dt.day;
            $("#exportForm")[0].action = "${exportUrl}.do?date=" + sdt;
            $("#exportForm")[0].submit();
        });
...
//                    var dt = getExportDate();
//                    jqtemplate.attr("exportdt", dt.year + "-" + dt.month + "-" + dt.day);
