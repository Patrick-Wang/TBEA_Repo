...
module plugin {
    export let byqnwbzlztqk : number = framework.basic.endpoint.lastId();
}
declare var echarts;
module nwbzlqk {
    export module byqnwbzlztqk {
        ...
        class ShowView extends ZlPluginView {
            ...
            private mAjax:Util.Ajax = new Util.Ajax("/BusinessManagement/byqnwbzlztqk/update.do", false);
            private mDt: string;
