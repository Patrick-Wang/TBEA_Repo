...
(function (jcycljg) {
    ...
    (function (jkzj) {
        ...
        var MyzsView = /** @class */ (function (_super) {
            __extends(MyzsView, _super);
            function MyzsView() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.mAjax = new Util.Ajax("/BusinessManagement/jcycljg/update.do?type=" + jcycljg.JcycljgType.JKZJ, false);
                return _this;
            ...
            MyzsView.prototype.adjustSize = function () {
                _super.prototype.adjustSize.call(this);
                this.updateChart();
            };
            MyzsView.prototype.createJqassist = function () {
                var parent = this.$(this.option().tb);
                parent.empty();
