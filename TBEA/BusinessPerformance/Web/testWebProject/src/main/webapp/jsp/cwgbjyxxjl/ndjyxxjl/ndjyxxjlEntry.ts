...
module cwgbjyxxjl {
    export module ndjyxxjlEntry {
        ...
        class EntryView extends framework.basic.EntryPluginView {
            ...
            private mAjaxUpdate:Util.Ajax = new Util.Ajax("../ndjyxxjl/entry/update.do", false);
            private mAjaxSave:Util.Ajax = new Util.Ajax("../ndjyxxjl/entry/save.do", false);
            private mAjaxSubmit:Util.Ajax = new Util.Ajax("../ndjyxxjl/entry/submit.do", false);
            private mDt:string;
