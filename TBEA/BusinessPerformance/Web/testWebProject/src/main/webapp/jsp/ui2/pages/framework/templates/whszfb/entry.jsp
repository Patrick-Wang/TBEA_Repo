...
<script src="${pageContext.request.contextPath}/jsp/ui2/pages/json2.js"
	type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/jsp/ui2/pages/util.js?ver=1.0"
	type="text/javascript"></script>
<script
...
<script
    ...
    <script src="${pageContext.request.contextPath}/jsp/ui2/pages/framework/templates/whszfb/entry.js"></script>
...
<body>
	...
	<script>
		...
		$(document).ready(function(){
			framework.templates.whszfb.createInstance();
