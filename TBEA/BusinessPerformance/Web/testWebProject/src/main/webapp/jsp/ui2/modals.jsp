...
.header-title .btn-group, .header-title .workinput, .header-title>.btn,
	.header-title select {
	margin-top: 8px;
}

.header-title select, .header-title>.btn {
	margin-left: 13px;
}
					...
					<div class="header-title">
						...
						<div class="btn-group">
							<a class="btn btn-default dropdown-toggle" data-toggle="dropdown"
								aria-expanded="false">导出 <i class="fa fa-angle-down"></i>
							</a>
							<ul class="dropdown-menu">
								<li><a id="export-all" href="javascript:void(0);">导出全部</a></li>
								<li><a id="export-xmgs" href="javascript:void(0);">导出项目公司</a></li>
							</ul>
							<form id="exportJydw" style="display: none" method="post"></form>
							<form id="exportxmgs" style="display: none" method="post"></form>
						</div>
					</div>
				</div>
				<!-- /Page Header -->
