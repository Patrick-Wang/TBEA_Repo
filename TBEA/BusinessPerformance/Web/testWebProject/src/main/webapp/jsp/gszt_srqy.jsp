...
<head>
    ...
    <script src="../jsp/gszt_srqy.js" type="text/javascript"></script>

    <script type="text/javascript">
    	var instance = gszt_srqy.View.newInstance();
        (function () {
    ...
    <title>${year}年${month}月 指标汇总2</title>
