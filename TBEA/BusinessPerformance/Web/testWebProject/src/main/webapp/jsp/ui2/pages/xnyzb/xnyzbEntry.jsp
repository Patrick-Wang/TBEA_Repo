...
<script
	src="${pageContext.request.contextPath}/jsp/ui2/pages/xnyzb/xnyzbdef.js"
	type="text/javascript"></script>
<script
	src="${pageContext.request.contextPath}/jsp/ui2/pages/xnyzb/xnyzbEntry.js"
	type="text/javascript"></script>
...
<body>
	...
	<script>
		...
		$(document).ready(
			function() {
				framework.router.to(framework.basic.endpoint.FRAME_ID)
