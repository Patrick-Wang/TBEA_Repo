...
<script src="../jsp/jygkzzy/cc_ccwcqk_byq_template.js" type="text/javascript"></script>
...
<script type="text/javascript">
	var view = cc_ccwcqk_byq_template.View.getInstance();
    (function () {
		$(document).ready(function () {
          	view.initBglxViewSelect({bglxId : "div_bglx", curbglx : "20012"});
            $("#bglx").val("20012");
            view.updateEntry(); 
			/*view.initInstance({
				tableId : "table",
