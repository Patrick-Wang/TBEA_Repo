...
<body>
	...
	window.data = {
			zl:[594,8896,1256,6463,4242,5258],
			kxxz:[2856,1542,2548,2321,4582,2563,1548,6985],
			yqys:[2851,6985,1472,3695,2483,2154,2154,2315],
			yjtz:[
				[rand(), "一月", rand(), rand(), rand(), rand(), rand(), rand(), rand(), rand(),  rand()],
				[rand(), "二月", rand(), rand(), rand(), rand(), rand(), rand(), rand(), rand(),  rand()],
				[rand(), "三月", rand(), rand(), rand(), rand(), rand(), rand(), rand(), rand(),  rand()],
				[rand(), "四月", rand(), rand(), rand(), rand(), rand(), rand(), rand(), rand(),  rand()],
				[rand(), "五月", rand(), rand(), rand(), rand(), rand(), rand(), rand(), rand(),  rand()],
				[rand(), "六月", rand(), rand(), rand(), rand(), rand(), rand(), rand(), rand(),  rand()],
				[rand(), "七月", rand(), rand(), rand(), rand(), rand(), rand(), rand(), rand(),  rand()],
				[rand(), "八月", rand(), rand(), rand(), rand(), rand(), rand(), rand(), rand(),  rand()],
				[rand(), "九月", rand(), rand(), rand(), rand(), rand(), rand(), rand(), rand(),  rand()],
				[rand(), "十月", rand(), rand(), rand(), rand(), rand(), rand(), rand(), rand(),  rand()],
				[rand(), "十一月", rand(), rand(), rand(), rand(), rand(), rand(), rand(), rand(),  rand()],
				[rand(), "十二月", rand(), rand(), rand(), rand(), rand(), rand(), rand(), rand(),  rand()]
			]
	};
