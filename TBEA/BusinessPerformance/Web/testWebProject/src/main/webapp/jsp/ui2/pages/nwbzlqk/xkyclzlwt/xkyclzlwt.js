...
var plugin;
(function (plugin) {
    plugin.xkyclzlwt = framework.basic.endpoint.lastId();
})(plugin || (plugin = {}));
var nwbzlqk;
(function (nwbzlqk) {
    var xkyclzlwt;
    (function (xkyclzlwt) {
        ...
        var ShowView = (function (_super) {
            ...
            function ShowView() {
                ...
                _this.mAjax = new Util.Ajax("/BusinessManagement/xkyclzlwt/update.do", false);
                return _this;
    ...
    })(xkyclzlwt = nwbzlqk.xkyclzlwt || (nwbzlqk.xkyclzlwt = {}));
})(nwbzlqk || (nwbzlqk = {}));
