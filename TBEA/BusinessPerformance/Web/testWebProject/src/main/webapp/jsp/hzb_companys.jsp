...
<head>
    ...
    <script src="../jsp/hzb_companys.js" type="text/javascript"></script>

    <script type="text/javascript">
    	var instance = hzb_companys.View.newInstance();
        (function () {
    ...
    <title>${year}年${month}月经营单位与项目公司指标完成情况</title>
...
<body>
    <div class=" header">
        <h1>${year}年${month}月经营单位与项目公司指标完成情况</h1>
    </div>
