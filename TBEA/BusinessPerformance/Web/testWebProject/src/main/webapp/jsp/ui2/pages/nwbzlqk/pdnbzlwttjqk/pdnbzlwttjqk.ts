...
module nwbzlqk {
    export module pdnbzlwttjqk {
        ...
        class ShowView extends ZlPluginView {
            ...
            private mAjax:Util.Ajax = new Util.Ajax("/BusinessManagement/pdnbzlwttjqk/update.do", false);
            ...
            pluginGetExportUrl(date:string, compType:Util.CompanyType):string {
                return "/BusinessManagement/pdnbzlwttjqk/export.do?" + Util.Ajax.toUrlParam({
                        date: date,
                        companyId:compType,
                        ydjd:this.mYdjdType
                 });
