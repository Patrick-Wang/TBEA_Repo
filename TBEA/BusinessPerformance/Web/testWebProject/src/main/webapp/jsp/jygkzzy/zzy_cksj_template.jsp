...
<script src="../jsp/jygkzzy/zzy_cksj_template.js" type="text/javascript"></script>
...
<script type="text/javascript">
	var view = zzy_cksj_template.View.getInstance();
	(function () {
		$(document).ready(function () {
			view.initBglxSelect({bglxId : "div_bglx",curbglx : "10001"});
			view.initInstance({
				tableId : "table",
				dateId:	"date",
				companyId: "company",
