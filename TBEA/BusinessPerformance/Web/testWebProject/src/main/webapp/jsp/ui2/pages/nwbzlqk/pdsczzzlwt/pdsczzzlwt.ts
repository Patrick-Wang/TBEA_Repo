...
module plugin {
    export let pdsczzzlwt : number = framework.basic.endpoint.lastId();
}
declare var echarts;
module nwbzlqk {
    export module pdsczzzlwt {
        ...
        class ShowView extends ZlPluginView {
            ...
            private mAjax:Util.Ajax = new Util.Ajax("/BusinessManagement/pdsczzzlwt/update.do", false);
            private mDt: string;
