<div id="byqcpycssbhgxxfb" class="sub-view">
	<div id="tbarea">
       <div class="well">
			<div id="table"></div>
		</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/jsp/ui2/pages/cpzlqk/byqcpycssbhgxxfb/byqcpycssbhgxxfb.js"></script>
