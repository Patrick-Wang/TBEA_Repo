...
<script src="${pageContext.request.contextPath}/jsp/ui2/pages/chgb/chgbdef.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/jsp/ui2/pages/chgb/chgb.js" type="text/javascript"></script>
<script
