...
module plugin {
    export let xksczzzlwtxxxx : number = framework.basic.endpoint.lastId();
}
declare var echarts;
module nwbzlqk {
    export module xksczzzlwtxxxx {
        ...
        class ShowView extends ZlPluginView {
            ...
            private mAjax:Util.Ajax = new Util.Ajax("/BusinessManagement/xksczzzlwtxxxx/update.do", false);
            private mDt: string;
