...
<script src="${pageContext.request.contextPath}/jsp/ui2/pages/cwcpdlml/cwcpdlmldef.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/jsp/ui2/pages/cwcpdlml/cwcpdlml.js" type="text/javascript"></script>
<script
