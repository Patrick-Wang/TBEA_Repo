...
module cpzlqk {
    export module xkadwtjjg {
        ...
        class ShowView extends ZlPluginView {
            ...
            private mAjax:Util.Ajax = new Util.Ajax("/BusinessManagement/xkadwtjjg/update.do", false);
            private tableAssist:JQTable.JQGridAssistant;
            private mAjaxStatus:Util.Ajax = new Util.Ajax("/BusinessManagement/xkacptjjg/updateStatus.do", false);
            private mDt: string;
            ...
            private mAjaxApprove:Util.Ajax = new Util.Ajax("/BusinessManagement/xkacptjjg/approve.do", false);
            getId():number {
                return plugin.xkadwtjjg;
            }
            ...
            pluginGetExportUrl(date:string, compType:Util.CompanyType):string {
                return "/BusinessManagement/xkadwtjjg/export.do?" + Util.Ajax.toUrlParam({
                        date: date,
                        companyId:compType,
                        ydjd:this.mYdjdType,
