...
<script src="${pageContext.request.contextPath}/jsp/ui2/pages/cbfx/cbfxdef.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/jsp/ui2/pages/cbfx/cbfxEntry.js" type="text/javascript"></script>
<script
