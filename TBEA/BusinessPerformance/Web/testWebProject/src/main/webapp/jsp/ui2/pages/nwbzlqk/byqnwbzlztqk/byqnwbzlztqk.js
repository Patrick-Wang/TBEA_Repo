...
(function (nwbzlqk) {
    ...
    (function (byqnwbzlztqk) {
        ...
        var ShowView = /** @class */ (function (_super) {
            ...
            function ShowView() {
                ...
                _this.mAjax = new Util.Ajax("/BusinessManagement/byqnwbzlztqk/update.do", false);
                return _this;
            ...
            ShowView.prototype.pluginGetExportUrl = function (date, compType) {
                return "/BusinessManagement/byqnwbzlztqk/export.do?" + Util.Ajax.toUrlParam({
                    date: date,
                    companyId: compType,
                    ydjd: this.mYdjdType
                });
    ...
    })(byqnwbzlztqk = nwbzlqk.byqnwbzlztqk || (nwbzlqk.byqnwbzlztqk = {}));
})(nwbzlqk || (nwbzlqk = {}));
