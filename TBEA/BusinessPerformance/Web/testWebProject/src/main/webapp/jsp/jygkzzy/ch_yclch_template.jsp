...
<head>
	...
	<script src="../jsp/jygkzzy/ch_yclch_template.js" type="text/javascript"></script>
	...
	<script type="text/javascript">
		var view = jygk_zzy_ch_yclch.View.getInstance();    
	    (function () {
	...
	<title>${year}年${month}月原材料存货</title>
