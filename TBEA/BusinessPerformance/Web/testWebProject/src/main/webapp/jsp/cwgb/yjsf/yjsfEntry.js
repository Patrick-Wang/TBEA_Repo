...
(function (pluginEntry) {
    pluginEntry.yjsf = framework.basic.endpoint.lastId();
...
(function (cwgb) {
    ...
    (function (yjsfEntry) {
        ...
        var EntryView = (function (_super) {
            ...
            function EntryView() {
                ...
                this.mAjaxUpdate = new Util.Ajax("../yjsf/entry/update.do", false);
                this.mAjaxSave = new Util.Ajax("../yjsf/entry/save.do", false);
                this.mAjaxSubmit = new Util.Ajax("../yjsf/entry/submit.do", false);
            }
            EntryView.prototype.getId = function () {
                return pluginEntry.yjsf;
            };
    ...
    })(yjsfEntry = cwgb.yjsfEntry || (cwgb.yjsfEntry = {}));
})(cwgb || (cwgb = {}));
