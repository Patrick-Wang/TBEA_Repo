...
<script src="../jsp/jygkzzy/fx_nhqk_template.js" type="text/javascript"></script>
...
<script type="text/javascript">
	var view = fx_nhqk_template.View.getInstance();
    (function () {
		$(document).ready(function () {
          	view.initBglxViewSelect({bglxId : "div_bglx", curbglx : "20021"});
            $("#bglx").val("20021");
            view.updateEntry(); 
			/*view.initInstance({
				tableId : "table",
