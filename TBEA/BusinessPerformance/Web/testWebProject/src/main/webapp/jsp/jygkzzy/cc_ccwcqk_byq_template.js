...
var cc_ccwcqk_byq_template;
(function (cc_ccwcqk_byq_template) {
    ...
    var View = (function () {
        ...
        View.prototype.updateEntry = function () {
            ...
            this.mCondition.get({ entryType: "20012" })
                .then(function (data) {
                _this.initInstance({
                    tableId: "table",
                    dateId: "date",
    ...
    cc_ccwcqk_byq_template.View = View;
})(cc_ccwcqk_byq_template || (cc_ccwcqk_byq_template = {}));
