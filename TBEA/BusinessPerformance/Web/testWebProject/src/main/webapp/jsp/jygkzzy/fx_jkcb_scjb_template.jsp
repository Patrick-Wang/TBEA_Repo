...
<script src="../jsp/jygkzzy/fx_jkcb_scjb_template.js" type="text/javascript"></script>
...
<script type="text/javascript">
	var view = fx_jkcb_scjb_template.View.getInstance();
    (function () {
		$(document).ready(function () {
          	view.initBglxViewSelect({bglxId : "div_bglx", curbglx : "20008"});
            $("#bglx").val("20008");
            view.updateEntry(); 
			/*view.initInstance({
				tableId : "table",
