...
module plugin {
    export let xkwbzlwtfl : number = framework.basic.endpoint.lastId();
}
declare var echarts;
module nwbzlqk {
    export module xkwbzlwtfl {
        ...
        class ShowView extends ZlPluginView {
            ...
            private mAjax:Util.Ajax = new Util.Ajax("/BusinessManagement/xkwbzlwtfl/update.do", false);
            private mDt: string;
