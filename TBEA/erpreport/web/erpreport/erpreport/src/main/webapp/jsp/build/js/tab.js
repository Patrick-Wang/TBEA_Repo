    ...
    var _tab = {
        ...
        createTabDom: function() {
            ...
            var tpl = [
                    ...
                    '<li class="layui-this" lay-id="-1" data-url="' + _config.mainUrl + '"><i class="layui-icon">&#xe68e;</i> 我的收藏</li>',
                    '</ul>',
            ...
            switch (_config.renderType) {
                ...
                case renderType.iframe:
                    _htm = _htm.replace('{{content}}', '<iframe  frameborder="0" src="' + _config.mainUrl + '"></iframe>');
                    break;
            }
            //渲染
            ...
            _win.on('resize', function() {
                ...
                switch (_config.renderType) {
                    case renderType.page:
                        ...
                        break;
                    case renderType.iframe:
                        $('.kit-tab .layui-tab-content iframe').height(currBoxHeight - 42);
                        $('.kit-tab .layui-tab-content iframe').parent().height(currBoxHeight - 42);
                        $('.kit-tab .layui-tab-content iframe').parent().css("overflow", "hidden");
                        break;
                }
            }).resize();
        },
        ...
        tabAdd: function(options) {
            ...
            switch (_config.renderType) {
                case renderType.page:
                    ...
                    break;
                case renderType.iframe:
                    contentHtm = contentHtm.replace('{{content}}', '<iframe frameborder="0" src="' + url + '"></iframe>');
                    break;
            }
            //追加htm
